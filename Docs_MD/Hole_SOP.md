...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[holeSOP_Class](<./HoleSOP_Class.md> "HoleSOP Class")
...
Extra Information for the Hole SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
