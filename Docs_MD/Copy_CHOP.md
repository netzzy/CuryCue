...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[copyCHOP_Class](<./CopyCHOP_Class.md> "CopyCHOP Class")
...
Where`default`is any initial value for the parameter, and is usually set to 0. __
...
Extra Information for the Copy CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
