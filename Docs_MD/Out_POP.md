...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[outPOP_Class](</OutPOP_Class> "OutPOP Class")
...
Extra Information for the Out POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
