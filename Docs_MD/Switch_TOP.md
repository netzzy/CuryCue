...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[switchTOP_Class](</SwitchTOP_Class> "SwitchTOP Class")
...
Extra Information for the Switch TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
