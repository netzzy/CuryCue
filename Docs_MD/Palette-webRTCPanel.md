...
The WebRTC Remote Panel COMP is a component that can be used to share a TouchDesigner component's panel over a [WebRTC](<./WebRTC.md> "WebRTC") connection. 
...
The receiving end of the connection should be a [WebRTC Remote Panel Receiver COMP](<./Palette-webRTCPanelRcv.md> "Palette:webRTCPanelRcv") or a web page designed to receive a WebRTC stream and a signaling client supporting TouchDesigner' [Signaling API and signalingServer COMP](<./Palette-signalingServer.md> "Palette:signalingServer"). 

A web based version of the webRTCPanelRcv component is available [in the following repository](<https://github.com/TouchDesigner/WebRTC-Remote-Panel-Web-Demo>) as well as an online demo following [this link](<https://touchdesigner.github.io/WebRTC-Remote-Panel-Web-Demo/>). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:webRTCPanel Ext](<./Palette-webRTCPanel_Ext.md> "Palette:webRTCPanel Ext")
...
* A [Palette:signalingServer](<./Palette-signalingServer.md> "Palette:signalingServer") COMP, from the Palette WebRTC folder
  * A [Palette:signalingClient](<./Palette-signalingClient.md> "Palette:signalingClient") COMP, from the Palette WebRTC folder
  * A Palette:webRTCPanel COMP, from the Palette WebRTC folder


On the [Palette:signalingServer](<./Palette-signalingServer.md> "Palette:signalingServer") COMP, turn the Active par to ON. 

On the [Palette:signalingClient](<./Palette-signalingClient.md> "Palette:signalingClient") COMP, turn the Active par to ON. Turn the Forward to Subscribers par to ON as well. 
...
* A [Palette:signalingClient](<./Palette-signalingClient.md> "Palette:signalingClient") COMP, from the Palette WebRTC folder
  * A [Palette:webRTCPanelRcv](<./Palette-webRTCPanelRcv.md> "Palette:webRTCPanelRcv") COMP, from the Palette WebRTC folder


On the signalingClient COMP, turn the Active par to ON. Turn the Forward to Subscribers par to ON as well. 

On the [Palette:webRTCPanelRcv](<./Palette-webRTCPanelRcv.md> "Palette:webRTCPanelRcv") COMP, reference the signalingClient COMP in the matching parameter. 

On the [Palette:webRTCPanelRcv](<./Palette-webRTCPanelRcv.md> "Palette:webRTCPanelRcv"), the drop down menu with the list of available clients should update. 
...
The remote panel should now appear in the viewer of the [Palette:webRTCPanelRcv](<./Palette-webRTCPanelRcv.md> "Palette:webRTCPanelRcv"). 
