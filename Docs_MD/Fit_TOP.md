...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fitTOP_Class](<./FitTOP_Class.md> "FitTOP Class")
...
Extra Information for the Fit TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
