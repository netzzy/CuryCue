...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Engine COMP](<./Engine_COMP.md> "Engine COMP").   
  
## Members

No operator specific members. 

## Methods`goToDone()`→`None`: 
...
TouchDesigner Build: Latest\nwikieditorwikieditorwikieditor2022.241402021.100002019.146502018.28070before 2018.28070
