...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[holdCHOP_Class](<./HoldCHOP_Class.md> "HoldCHOP Class")
...
Extra Information for the Hold CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
