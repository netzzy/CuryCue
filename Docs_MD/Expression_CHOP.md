...
See also [Evaluate DAT](<./Evaluate_DAT.md> "Evaluate DAT") for easy evaluation of any expression. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[expressionCHOP_Class](<./ExpressionCHOP_Class.md> "ExpressionCHOP Class")
...
Extra Information for the Expression CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
