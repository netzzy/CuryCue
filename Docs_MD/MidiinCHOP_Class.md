...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [MIDI In CHOP](<./MIDI_In_CHOP.md> "MIDI In CHOP"). 

## Members`timecode`→`tdu.Timecode`**(Read Only)** : 

> Get a Timecode object representation of the last set of quarter frame messages. See [Timecode Class](<./Timecode_Class.md> "Timecode Class").
