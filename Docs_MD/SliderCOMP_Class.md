...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Slider COMP](<./Slider_COMP.md> "Slider COMP").   
  
## Members

No operator specific members. 

## Methods`click(uOrV, v, clickCount=1, force=False, left=False, middle=False, right=False, vOnly=False)`→`None`: 
