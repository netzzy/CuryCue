...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[warpCHOP_Class](</WarpCHOP_Class> "WarpCHOP Class")
...
The Warp CHOP does linear interpolation of the Pre-Warped Channels when they are both stretched and compressed. __
...
Extra Information for the Warp CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
