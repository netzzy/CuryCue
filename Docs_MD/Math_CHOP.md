...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mathCHOP_Class](<./MathCHOP_Class.md> "MathCHOP Class")
...
* Extend to Min/Max`none`\- Find the earliest start and latest end, and extend all inputs to that range using the extend conditions. (see [Extend Conditions](<./Extend_Conditions.md> "Extend Conditions")).
...
Extra Information for the Math CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
