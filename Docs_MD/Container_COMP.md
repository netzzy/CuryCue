...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[containerCOMP_Class](<./ContainerCOMP_Class.md> "ContainerCOMP Class")
...
Extra Information for the Container COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
