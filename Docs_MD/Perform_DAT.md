...
The Perform DAT logs various performance times in a [Table DAT](<./Table_DAT.md> "Table DAT") format. These benchmarks are similar to those reported by the [Performance Monitor](<./Performance_Monitor_Dialog.md> "Performance Monitor Dialog"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[performDAT_Class](<./PerformDAT_Class.md> "PerformDAT Class")
...
Custom Panel Time`logcustompanel`\- Logs time taken by custom panels build with [Panel Components](<./Panel_Component.md> "Panel Component"). 
...
Extra Information for the Perform DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
