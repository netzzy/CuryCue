...
See also [OpenVR](<./OpenVR.md> "OpenVR"), [OpenVR CHOP](<./OpenVR_CHOP.md> "OpenVR CHOP"), [OpenVR SOP](<./OpenVR_SOP.md> "OpenVR SOP"), [Audio Render CHOP](<./Audio_Render_CHOP.md> "Audio Render CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[openvrTOP_Class](<./OpenvrTOP_Class.md> "OpenvrTOP Class")
...
Extra Information for the OpenVR TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
