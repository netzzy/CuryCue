...
Resample does a simple linear interpolation of the Time Slice in [Time Slicing](<./Time_Slicing.md> "Time Slicing") mode. Only the sample rate can be changed. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[resampleCHOP_Class](<./ResampleCHOP_Class.md> "ResampleCHOP Class")
...
Extra Information for the Resample CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
