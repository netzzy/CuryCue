...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[reorderDAT_Class](</ReorderDAT_Class> "ReorderDAT Class")
...
Extra Information for the Reorder DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
