...
See also the [LFO CHOP](<./LFO_CHOP.md> "LFO CHOP") to get an endless stream of pulses that is [Time Sliced](</index.php?title=Time_Slice&action=edit&redlink=1> "Time Slice \(page does not exist\)"), and the [Pattern CHOP](<./Pattern_CHOP.md> "Pattern CHOP") for a string of static pulses. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[pulseCHOP_Class](<./PulseCHOP_Class.md> "PulseCHOP Class")
...
Extra Information for the Pulse CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
