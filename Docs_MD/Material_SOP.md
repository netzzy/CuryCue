...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[materialSOP_Class](<./MaterialSOP_Class.md> "MaterialSOP Class")
...
Extra Information for the Material SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
