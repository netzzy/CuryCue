...
The Stype TOP works with [Stype](<./Stype.md> "Stype") (**RedSpy**) camera trackers to perform simulated lens distortion using channels from a connected CHOP. 

**NOTE:** This CHOP works with [Stype](<https://www.stype.tv>) hardware. See also [Stype](<./Stype.md> "Stype") and [Stype CHOP](<./Stype_CHOP.md> "Stype CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[stypeTOP_Class](</StypeTOP_Class> "StypeTOP Class")

## 

Parameters - Stype Page

CHOP Node`chop`\- Reference to a CHOP that outputs the lens distortion parameters. This can be a [Stype CHOP](<./Stype_CHOP.md> "Stype CHOP") or another operator that has the channels _k1_ , _k2_ , _centerx_ , _centery_ , _pawidth_ and _paheight_ defined. See [Stype CHOP](<./Stype_CHOP.md> "Stype CHOP") for more information on these channels. 

Padding`padding`\- Only enabled when the _CHOP Node_ parameter does not reference a [Stype CHOP](<./Stype_CHOP.md> "Stype CHOP"). This parameter indicates if any padding has been provided on the source image and then crops the output accordingly. See the [Stype CHOP](<./Stype_CHOP.md> "Stype CHOP") for more information on padding. 
...
Extra Information for the Stype TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
