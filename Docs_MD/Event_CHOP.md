...
**NOTE** : See the examples in Help->[OP Snippets](<./OP_Snippets.md> "OP Snippets")
...
Watch the channel graph of the Event CHOP to understand what it is doing. It can be sent to a [Limit SOP](<./Limit_SOP.md> "Limit SOP") or a [Channel SOP](<./CHOP_to_SOP.md> "CHOP to SOP") to place geometry for each event. You can send event information to the SOP via the Event CHOP channels that get transformed into geometry channels like`tx`,`ty`,`scale`, texture v (giving movie time offsets), alpha, r, g and b colors. 
...
See also: [Timer CHOP](<./Timer_CHOP.md> "Timer CHOP"), [Count CHOP](<./Count_CHOP.md> "Count CHOP"), [Speed CHOP](<./Speed_CHOP.md> "Speed CHOP"), [Trigger CHOP](<./Trigger_CHOP.md> "Trigger CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[eventCHOP_Class](<./EventCHOP_Class.md> "EventCHOP Class")
...
Goes from 0 to 1 during the attack phase, 1 to 2 as it repeats in the sustain phase, and 2 to 3 in the release phase. It is suitable for indexing movies. __
...
Extra Information for the Event CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
