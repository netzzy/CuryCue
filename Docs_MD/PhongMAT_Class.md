...
This class inherits from the [ MAT class](<./MAT_Class.md> "MAT Class"). It references a specific [Phong MAT](<./Phong_MAT.md> "Phong MAT").   
  
## Members

No operator specific members. 

## Methods`outputShader(includeGeoShader=False, instanceTexturing=False)`→`glslMAT`: 
