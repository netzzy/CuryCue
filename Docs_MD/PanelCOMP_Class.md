...
The PanelCOMP describes an instance of a [Panel Component](<./Panel_Component.md> "Panel Component"). The state is represented by [Panel Values](<./Panel_Value.md> "Panel Value"). This class inherits from the COMP Class. 
