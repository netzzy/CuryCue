...
A Poly describes an instance of a single [geometry polygon](<./Polygon.md> "Polygon"). It is an instance of a [Prim Class](<./Prim_Class.md> "Prim Class"). 

## Members`closed`→`bool`**(Read Only)** : 
