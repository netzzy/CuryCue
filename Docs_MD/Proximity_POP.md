...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[proximityPOP_Class](</ProximityPOP_Class> "ProximityPOP Class")
...
Extra Information for the Proximity POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
