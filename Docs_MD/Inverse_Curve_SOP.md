...
The Inverse Curve SOP takes data from an [Inverse Curve CHOP](<./Inverse_Curve_CHOP.md> "Inverse Curve CHOP") and builds a curve from it. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inversecurveSOP_Class](<./InversecurveSOP_Class.md> "InversecurveSOP Class")
...
Extra Information for the Inverse Curve SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
