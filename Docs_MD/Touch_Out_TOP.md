...
It can output [Hap Q](<./Hap.md> "Hap"), Hap Q Alpha, and Uncompressed video. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[touchoutTOP_Class](<./TouchoutTOP_Class.md> "TouchoutTOP Class")
...
Extra Information for the Touch Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
