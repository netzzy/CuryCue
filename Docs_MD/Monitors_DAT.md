...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[monitorsDAT_Class](<./MonitorsDAT_Class.md> "MonitorsDAT Class")

## 

Parameters - Monitors Page

Callbacks DAT`callbacks`\- Runs this script once for each change to the table (ie. monitor state change). See [monitorsDAT_Class](<./MonitorsDAT_Class.md> "MonitorsDAT Class") for usage. 
...
Extra Information for the Monitors DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
