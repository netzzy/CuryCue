...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inTOP_Class](<./InTOP_Class.md> "InTOP Class")
...
Extra Information for the In TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
