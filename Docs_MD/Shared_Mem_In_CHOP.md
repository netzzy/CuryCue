...
See [Using Shared Memory in TouchDesigner](<./Using_Shared_Memory_in_TouchDesigner.md> "Using Shared Memory in TouchDesigner"), [Write a Shared Memory CHOP](<./Write_a_Shared_Memory_CHOP.md> "Write a Shared Memory CHOP") and the [Pipe In CHOP](<./Pipe_In_CHOP.md> "Pipe In CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sharedmeminCHOP_Class](</SharedmeminCHOP_Class> "SharedmeminCHOP Class")
...
* Global`global`\- This mode uses a combined shared memory segment that all of the nodes will read for. More details in the [Global Shared Memory](<./Shared_Memory.htm#Global_Shared_Memory> "Shared Memory") article.
...
Extra Information for the Shared Mem In CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
