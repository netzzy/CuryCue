...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fractalSOP_Class](<./FractalSOP_Class.md> "FractalSOP Class")
...
Extra Information for the Fractal SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
