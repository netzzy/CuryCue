...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sortCHOP_Class](<./SortCHOP_Class.md> "SortCHOP Class")
...
Extra Information for the Sort CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
