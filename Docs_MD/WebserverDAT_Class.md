...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [Web Server DAT](<./Web_Server_DAT.md> "Web Server DAT"). 

## Members`webSocketConnections`→ **(Read Only)** : 

> A string list of all the Web Socket connections in the server.

## Methods`authenticateBasic(token, userPasswords)`→`bool`: 
