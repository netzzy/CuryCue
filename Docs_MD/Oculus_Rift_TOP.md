...
The Oculus Rift TOP connects to an [Oculus Rift](<./Oculus_Rift.md> "Oculus Rift") device and applies a distortion to input textures based on the device's calibration parameters. There are separate inputs for each eye. 

See also [Oculus Rift](<./Oculus_Rift.md> "Oculus Rift")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[oculusriftTOP_Class](<./OculusriftTOP_Class.md> "OculusriftTOP Class")
...
Extra Information for the Oculus Rift TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
