...
The [Script CHOP](<./Script_CHOP.md> "Script CHOP") enables numPy arrays to be converted into the CHOP's channels. Also any CHOP can get its channels converted into numPy arrays. (May 2021) 

See`numPyArray()`in [TOP Class](<./TOP_Class.md> "TOP Class")., [Script DAT](<./Script_DAT.md> "Script DAT"). 

See also [Script CHOP](<./Script_CHOP.md> "Script CHOP"), [Script SOP](<./Script_SOP.md> "Script SOP")

**Note:** This TOP supports 3D Textures and 2D Texture Arrays. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[scriptTOP_Class](<./ScriptTOP_Class.md> "ScriptTOP Class")
...
Extra Information for the Script TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
