...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [OP Viewer COMP](<./OP_Viewer_COMP.md> "OP Viewer COMP"). 

## Members

## Methods`isViewable(path)`→`bool`: 
