...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Field COMP](<./Field_COMP.md> "Field COMP").   
  
## Members

No operator specific members. 

## Methods`setKeyboardFocus(selectAll=False)`→`None`: 
