...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[envelopeCHOP_Class](<./EnvelopeCHOP_Class.md> "EnvelopeCHOP Class")
...
Extra Information for the Envelope CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
