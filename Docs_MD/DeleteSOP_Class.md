...
## Members`inputPoint`→`int`**(Read Only)** : 

> The current [point](<./Point_Class.md> "Point Class") being evaluated. Can only be used in the parameters for this SOP.`inputPrim`→`int`**(Read Only)** : 

> The current [primitive](<./Prim_Class.md> "Prim Class") being evaluated. Can only be used in the parameters for this SOP.
