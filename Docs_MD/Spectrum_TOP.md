...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[spectrumTOP_Class](</SpectrumTOP_Class> "SpectrumTOP Class")
...
Extra Information for the Spectrum TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
