...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Nvidia Flex Solver COMP](<./Nvidia_Flex_Solver_COMP.md> "Nvidia Flex Solver COMP"). 

## Members`actors`→`list`**(Read Only)** : 
