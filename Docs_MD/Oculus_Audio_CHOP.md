...
See also: [Audio Render CHOP](<./Audio_Render_CHOP.md> "Audio Render CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[oculusaudioCHOP_Class](<./OculusaudioCHOP_Class.md> "OculusaudioCHOP Class")
...
Extra Information for the Oculus Audio CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
