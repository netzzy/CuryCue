...
The ReRange POP takes any attribute of its input, re-ranges its values, and outputs them to the same attribute, any other existing attribute or a new attribute. It operates on either point, vertex or primitive [attributes](<./Attribute.md> "Attribute"). 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[rerangePOP_Class](<./RerangePOP_Class.md> "RerangePOP Class")
...
Extra Information for the ReRange POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
