...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[directxoutTOP_Class](<./DirectxoutTOP_Class.md> "DirectxoutTOP Class")
...
Queue Size`queuesize`\- Number of DirectX textures created. These textures are updated in a cycle, 1 per frame. Use an [Info DAT](<./Info_DAT.md> "Info DAT") to inspect the list of textures. 
...
Extra Information for the DirectX Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
