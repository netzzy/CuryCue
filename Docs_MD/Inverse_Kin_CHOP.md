...
The Inverse Kin CHOP calculates an inverse kinematics simulation for [Bone objects](<./Bone_COMP.md> "Bone COMP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inversekinCHOP_Class](<./InversekinCHOP_Class.md> "InversekinCHOP Class")
...
Extra Information for the Inverse Kin CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
