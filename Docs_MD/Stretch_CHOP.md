...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[stretchCHOP_Class](<./StretchCHOP_Class.md> "StretchCHOP Class")
...
Extra Information for the Stretch CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
