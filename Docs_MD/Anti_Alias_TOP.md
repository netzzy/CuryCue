...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[antialiasTOP_Class](<./AntialiasTOP_Class.md> "AntialiasTOP Class")
...
Extra Information for the Anti Alias TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
