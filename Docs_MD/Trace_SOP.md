...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[traceSOP_Class](</TraceSOP_Class> "TraceSOP Class")
...
Extra Information for the Trace SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
