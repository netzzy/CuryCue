...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Blob Track CHOP](<./Blob_Track_CHOP.md> "Blob Track CHOP").   
