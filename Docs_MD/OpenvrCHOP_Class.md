...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [OpenVR CHOP](<./OpenVR_CHOP.md> "OpenVR CHOP"). 

## Members

No operator specific members. 

## Methods`triggerHapticPulse(controllerIndex, analogIndex, durationMilliseconds)`→`None`: 
