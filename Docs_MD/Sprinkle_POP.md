...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sprinklePOP_Class](</SprinklePOP_Class> "SprinklePOP Class")
...
Extra Information for the Sprinkle POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
