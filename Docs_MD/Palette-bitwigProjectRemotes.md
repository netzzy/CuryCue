...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:bitwigProjectRemotes1 Ext](</index.php?title=Palette:bitwigProjectRemotes1_Ext&action=edit&redlink=1> "Palette:bitwigProjectRemotes1 Ext \(page does not exist\)")
...
TouchDesigner Build: Latest\nwikieditor2023.11280Error while fetching data from URL [https://ec2-3-23-171-62.us-east-2.compute.amazonaws.com/api.php?action=query&list=categorymembers&cmtitle=Category:Palette&format=xml&cmlimit=500](<https://ec2-3-23-171-62.us-east-2.compute.amazonaws.com/api.php?action=query&list=categorymembers&cmtitle=Category:Palette&format=xml&cmlimit=500>): $2.  
Error fetching URL: SSL: no alternative certificate subject name matches target host name 'ec2-3-23-171-62.us-east-2.compute.amazonaws.com'  
There was a problem during the HTTP request: 0 Error  
Could not get URL [https://ec2-3-23-171-62.us-east-2.compute.amazonaws.com/api.php?action=query&list=categorymembers&cmtitle=Category:Palette&format=xml&cmlimit=500](<https://ec2-3-23-171-62.us-east-2.compute.amazonaws.com/api.php?action=query&list=categorymembers&cmtitle=Category:Palette&format=xml&cmlimit=500>) after 3 tries.
