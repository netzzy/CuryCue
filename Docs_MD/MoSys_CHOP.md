...
The MoSys CHOP receives data from a [MoSys](<./MoSys.md> "MoSys") camera tracking system. The channels can be used to control a virtual [camera](<./Camera_COMP.md> "Camera COMP") and to implement lens distortion via the [MoSys TOP](<./MoSys_TOP.md> "MoSys TOP") as part of a virtual production system. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mosysCHOP_Class](<./MosysCHOP_Class.md> "MosysCHOP Class")
