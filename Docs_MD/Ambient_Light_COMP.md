...
The Ambient Light Component controls the color and intensity of the environmental light in a given scene. This light, unlike the [Light Component](<./Light_COMP.md> "Light COMP"), has no particular source. The light it sheds comes from everywhere as opposed to a point light source or focused spotlight. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[ambientlightCOMP_Class](<./AmbientlightCOMP_Class.md> "AmbientlightCOMP Class")
...
Extra Information for the Ambient Light COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
