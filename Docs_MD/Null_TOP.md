...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nullTOP_Class](<./NullTOP_Class.md> "NullTOP Class")
...
Extra Information for the Null TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
