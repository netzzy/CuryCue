...
The Slider Component lets you build sliders in X, Y and XY, and outputs 1 or 2 channels from a [Panel CHOP](<./Panel_CHOP.md> "Panel CHOP") placed in the Slider component. 

Default Slider Component

See [Panel Value](<./Panel_Value.md> "Panel Value"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sliderCOMP_Class](<./SliderCOMP_Class.md> "SliderCOMP Class")
...
* Slider U`slideru`\- A horizontal slider that tracks movement only in the **u** [Panel Value](<./Panel_Value.md> "Panel Value").
* Slider V`sliderv`\- A vertical slider that tracks movement only in the **v** [Panel Value](<./Panel_Value.md> "Panel Value").
* Slider UV`slideruv`\- A slider that tracks movement in both **u** and **v** [Panel Values](<./Panel_Value.md> "Panel Value").
...
Extra Information for the Slider COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
