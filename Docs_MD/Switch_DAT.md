...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[switchDAT_Class](</SwitchDAT_Class> "SwitchDAT Class")
...
Extra Information for the Switch DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
