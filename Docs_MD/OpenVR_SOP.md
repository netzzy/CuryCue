...
The [OpenVR](<./OpenVR.md> "OpenVR") SOP loads various models that the OpenVR driver for the installed device provides. This can be models of the controllers, headset and other peripherals. What the driver returns is entirely up to the manufacturer and can change between driver versions. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[openvrSOP_Class](<./OpenvrSOP_Class.md> "OpenvrSOP Class")
...
Extra Information for the OpenVR SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
