...
In each [sequential block](<./Sequential_Parameters.htm#Sequence_Blocks> "Sequential Parameters"), you need to specify an attribute to create. You can use`?`in`P(?)`to specify that columns`P(0)`,`P(1)`and`P(2)`will form a float3 vector`P`. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[dattoPOP_Class](</DattoPOP_Class> "DattoPOP Class")
...
Extra Information for the DAT to POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
