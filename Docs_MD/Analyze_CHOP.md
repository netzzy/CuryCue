...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[analyzeCHOP_Class](<./AnalyzeCHOP_Class.md> "AnalyzeCHOP Class")
...
Extra Information for the Analyze CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
