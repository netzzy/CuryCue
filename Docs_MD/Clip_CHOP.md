...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[clipCHOP_Class](<./ClipCHOP_Class.md> "ClipCHOP Class")
...
Extra Information for the Clip CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
