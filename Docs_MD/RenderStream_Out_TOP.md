...
Send image data out to [RenderStream](<./RenderStream.md> "RenderStream"). The actual setup and sync of the RenderStream connection is done with the [RenderStream In CHOP](<./RenderStream_In_CHOP.md> "RenderStream In CHOP"). 

See also [RenderStream In CHOP](<./RenderStream_In_CHOP.md> "RenderStream In CHOP"), [RenderStream In TOP](<./RenderStream_In_TOP.md> "RenderStream In TOP"), [RenderStream](<./RenderStream.md> "RenderStream"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[renderstreamoutTOP_Class](</RenderstreamoutTOP_Class> "RenderstreamoutTOP Class")
...
Extra Information for the RenderStream Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
