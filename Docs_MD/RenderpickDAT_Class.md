...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [Render Pick DAT](<./Render_Pick_DAT.md> "Render Pick DAT"). 

## Members

No operator specific members. 

## Methods`pick(u, v, camera=None)`→`RenderPickEvent`: 

> Perform a pick at the given (u, v) 
> 
>   * u - The u coordinate of the pick.
>   * v - The v coordinate of the pick.
>   * camera - (Keyword, Optional) If provided, the pick will be done from the point of view of the given camera. This can be any [COMP](<./Component.md> "Component") that behaves as a camera such as [Camera COMP](<./Camera_COMP.md> "Camera COMP"), [Light COMP](<./Light_COMP.md> "Light COMP") etc.
> 
