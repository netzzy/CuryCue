...
[![TouchGeometry72.gif](./images/2/25/TouchGeometry72.gif)](</File:TouchGeometry72.gif>)

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[alignSOP_Class](<./AlignSOP_Class.md> "AlignSOP Class")
...
Extra Information for the Align SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
