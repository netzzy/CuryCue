...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[joinCHOP_Class](<./JoinCHOP_Class.md> "JoinCHOP Class")
...
Extra Information for the Join CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
