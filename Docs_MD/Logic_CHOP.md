...
**NOTE:** The Logic CHOP is superceded by more convenient operators like the [CHOP Execute DAT](<./CHOP_Execute_DAT.md> "CHOP Execute DAT") or the [Text DAT](<./Text_DAT.md> "Text DAT") which will run their scripts when CHOP channels change. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[logicCHOP_Class](<./LogicCHOP_Class.md> "LogicCHOP Class")
...
* Last Two On`radio2`\- This is like Radio Button, but it keeps up to two channels on. If followed by a [Lag CHOP](<./Lag_CHOP.md> "Lag CHOP"), it is useful for blending between pairs of poses.
...
Extra Information for the Logic CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
