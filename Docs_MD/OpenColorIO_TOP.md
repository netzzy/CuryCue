...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[opencolorioTOP_Class](<./OpencolorioTOP_Class.md> "OpencolorioTOP Class")
...
Note that the file will expect a certain color space and file transforms do not internally handle this, so ensure that the image is in the correct color space before applying the transform or you will get incorrect results. __
...
Extra Information for the OpenColorIO TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
