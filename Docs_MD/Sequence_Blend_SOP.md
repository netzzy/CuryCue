...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sequenceblendSOP_Class](</SequenceblendSOP_Class> "SequenceblendSOP Class")
...
Extra Information for the Sequence Blend SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
