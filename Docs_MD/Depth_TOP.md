...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[depthTOP_Class](<./DepthTOP_Class.md> "DepthTOP Class")
...
Camera Index`cameraindex`\- When using [Multi-Camera Rendering](<./Multi-Camera_Rendering.md> "Multi-Camera Rendering"), chooses which camera's output to select. 
...
Extra Information for the Depth TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
