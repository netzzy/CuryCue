...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[selectSOP_Class](</SelectSOP_Class> "SelectSOP Class")
...
Extra Information for the Select SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
