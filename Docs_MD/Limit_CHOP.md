...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[limitCHOP_Class](<./LimitCHOP_Class.md> "LimitCHOP Class")
...
Normalize`norm`\- Scale and offset the channel so that it lies between -1 and +1. The Normalize function does not work with [Time Slicing](<./Time_Slicing.md> "Time Slicing") on. 
...
Extra Information for the Limit CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
