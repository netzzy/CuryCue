...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[linesmoothPOP_Class](<./LinesmoothPOP_Class.md> "LinesmoothPOP Class")
...
Extra Information for the Line Smooth POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
