...
The OP Viewer TOP can display the [Node Viewer](<./Node_Viewer.md> "Node Viewer") for any other operator as a TOP image. If the operator source is a [Panel Component](<./Panel_Component.md> "Panel Component"), panel interaction through the TOP image is also supported. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[opviewerTOP_Class](<./OpviewerTOP_Class.md> "OpviewerTOP Class")
...
Allow Panel Interaction`allowpanel`\- This option is being deprecated. Please see [OP Viewer COMP](<./OP_Viewer_COMP.md> "OP Viewer COMP") for its replacement. 
...
Extra Information for the OP Viewer TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
