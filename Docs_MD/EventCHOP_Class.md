...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Event CHOP](<./Event_CHOP.md> "Event CHOP"). 

## Members

No operator specific members. 

## Methods`releaseEvent(id)`→`int`: 
...
>     
[/code]`createEvent(hold=False, samples=[], index=0, attackTime=None, attackLevel=None, decayTime=None, sustainTime=None, sustainMin=None, sustainMax=None, releaseTime=None, releaseLevel=None, speed=None)`→`int`: 
