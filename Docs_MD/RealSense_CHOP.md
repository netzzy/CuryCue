...
**DEPRECATED:** Skeleton tracking features no longer licensable by Cubemos. [RealSense](<./RealSense.md> "RealSense") is a tracking device from Intel. The RealSense CHOP references a [RealSense TOP](<./RealSense_TOP.md> "RealSense TOP") camera and fetches tracking data from it. The RealSense CHOP supports skeleton tracking through the [Cubemos Skeleton Tracking API](<https://www.intelrealsense.com/skeleton-tracking/>). [Cubemos](<./Cubemos.md> "Cubemos") is Windows only. A Cubemos license is required to use the skeleton tracking. 
...
See also: [RealSense](<./RealSense.md> "RealSense"), [RealSense TOP](<./RealSense_TOP.md> "RealSense TOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[realsenseCHOP_Class](<./RealsenseCHOP_Class.md> "RealsenseCHOP Class")
...
Extra Information for the RealSense CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
