...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inSOP_Class](<./InSOP_Class.md> "InSOP Class")
...
Extra Information for the In SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
