...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[insideTOP_Class](<./InsideTOP_Class.md> "InsideTOP Class")
...
Extra Information for the Inside TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
