...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[posistagenetCHOP_Class](<./PosistagenetCHOP_Class.md> "PosistagenetCHOP Class")
...
Extra Information for the PosiStageNet CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
