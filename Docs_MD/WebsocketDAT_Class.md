...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [WebSocket DAT](<./WebSocket_DAT.md> "WebSocket DAT"). 

## Members

No operator specific members. 

## Methods`sendText(message)`→`int`: 
