...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[syphonspoutinTOP_Class](<./SyphonspoutinTOP_Class.md> "SyphonspoutinTOP Class")
...
Extra Information for the Syphon Spout In TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
