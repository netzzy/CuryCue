...
A further transform can be applied by specifying a Look At component (typically a [Null COMP](<./Null_COMP.md> "Null COMP") or [Geometry COMP](<./Geometry_COMP.md> "Geometry COMP")), and choosing which axis points to the origin of that component. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[transformPOP_Class](<./TransformPOP_Class.md> "TransformPOP Class")
...
Extra Information for the Transform POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
