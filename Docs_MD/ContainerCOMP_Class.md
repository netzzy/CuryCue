...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Container COMP](<./Container_COMP.md> "Container COMP").   
  
## Members

No operator specific members. 

## Methods`click(u, v, clickCount=1, force=False, left=False, middle=False, right=False, group=None)`→`None`: 
...
>     
[/code]`clickChild(childIndex, clickCount=1, force=False, left=False, middle=False, right=False, group=None)`→`None`: 
