...
Note that this feature can not be used in the same project as the [ZED](<./ZED.md> "ZED") device, due to version conflicts with TensorRT.  
...
The denoising engine only supports videos with a _width from 80-1920 pixels_ and _height from 90-1080 pixels_. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nvidiadenoiseTOP_Class](<./NvidiadenoiseTOP_Class.md> "NvidiadenoiseTOP Class")
...
Extra Information for the Nvidia Denoise TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
