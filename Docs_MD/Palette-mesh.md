...
The Mesh COMP creates a SOP based on the selected parametric equation in the "shape" parameter. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:mesh Ext](</index.php?title=Palette:mesh_Ext&action=edit&redlink=1> "Palette:mesh Ext \(page does not exist\)")

## 

Parameters - Mesh Page
...
For NURBS and Bzier surfaces, the Rows & Cols refer to the surface hull construction, and as such, the number of Rows and Cols should not be less than the Order in U or V. __
...
Shape`Shape`\- ⊞ \- A list of parametric equations that modifies the structure of the SOP. 
* Paraboloid`paraboloid`-
* Steinbach`steinbach`-
* Sine`sine`-
* Figure 8`figure8`-
* Elliptic Torus`ellipticTorus`-
* Corkscrew`corkscrew`-
* Bohemian Dome`bohemianDome`-
* Bow`bow`-
* Maeders Owl`maedersOwl`-
* Astroidal Ellipsoid`astroidalEllipsoid`-
* Triaxial Tritorus`triAxialTriTorus`-
* Limpet Torus`limpetTorus`-
* Horn`Horn`-
* Shell`Shell`-
* Kidney`Kidney`-
