...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fileinSOP_Class](<./FileinSOP_Class.md> "FileinSOP Class")
...
Extra Information for the File In SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
