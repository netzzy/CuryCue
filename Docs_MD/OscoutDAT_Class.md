...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [OSC Out DAT](<./OSC_Out_DAT.md> "OSC Out DAT"). 

## Members

No operator specific members. 

## Methods`sendBytes(*messages)`→`int`: 
...
TouchDesigner Build: Latest\nwikieditorwikieditorwikieditormw-undomw-reverted2021.100002018.28070before 2018.28070
