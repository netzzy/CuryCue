...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[polyreduceSOP_Class](<./PolyreduceSOP_Class.md> "PolyreduceSOP Class")
...
Extra Information for the Polyreduce SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
