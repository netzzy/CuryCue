...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Device In CHOP](<./Audio_Device_In_CHOP.md> "Audio Device In CHOP"). 
