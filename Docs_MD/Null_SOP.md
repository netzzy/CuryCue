...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nullSOP_Class](<./NullSOP_Class.md> "NullSOP Class")
...
Extra Information for the Null SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
