...
The PreFilter TOP uses spherical harmonics to calculate a Pre-Filtered Diffuse Map or Pre-Filtered Specular Map for use in the [Environment Light COMP](<./Environment_Light_COMP.md> "Environment Light COMP"). The output of the PreFilter Map TOP can not have further processing done to them before being used by the Environment Light. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[prefiltermapTOP_Class](<./PrefiltermapTOP_Class.md> "PrefiltermapTOP Class")
...
Extra Information for the PreFilter Map TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
