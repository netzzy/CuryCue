...
**TIP:** The [TCP/IP DAT](<./TCP/IP_DAT.md> "TCP/IP DAT") or [UDP In DAT](<./UDP_In_DAT.md> "UDP In DAT") is the preferred way to send script commands and other data packets over the network. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[pipeinCHOP_Class](<./PipeinCHOP_Class.md> "PipeinCHOP Class")
...
Callbacks DAT`callbacks`\- Path to a DAT containing callbacks for each event received. See [pipeinCHOP_Class](<./PipeinCHOP_Class.md> "PipeinCHOP Class") for usage. 
