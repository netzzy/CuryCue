...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[polypatchSOP_Class](<./PolypatchSOP_Class.md> "PolypatchSOP Class")

## 

Parameters - Polypatch Page

Group`group`\- Subset of input to use. Accepts patterns, as described in [Pattern Matching](<./Pattern_Matching.md> "Pattern Matching"). 
...
Extra Information for the Polypatch SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
