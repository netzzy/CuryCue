...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[slopeTOP_Class](<./SlopeTOP_Class.md> "SlopeTOP Class")
...
Extra Information for the Slope TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
