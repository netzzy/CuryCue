...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[outDAT_Class](<./OutDAT_Class.md> "OutDAT Class")
...
Extra Information for the Out DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
