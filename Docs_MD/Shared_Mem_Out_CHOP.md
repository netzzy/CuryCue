...
See [Using Shared Memory in TouchDesigner](<./Using_Shared_Memory_in_TouchDesigner.md> "Using Shared Memory in TouchDesigner"), [Write a Shared Memory CHOP](<./Write_a_Shared_Memory_CHOP.md> "Write a Shared Memory CHOP") and [Pipe Out CHOP](<./Pipe_Out_CHOP.md> "Pipe Out CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sharedmemoutCHOP_Class](</SharedmemoutCHOP_Class> "SharedmemoutCHOP Class")
...
Extra Information for the Shared Mem Out CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
