...
For more information on writing a shader, see the [GLSL Category](<./Category-GLSL.md> "Category:GLSL"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[glslCOMP_Class](</GlslCOMP_Class> "GlslCOMP Class")
...
Refer to the [Texture Sampling Parameters](<./Texture_Sampling_Parameters.md> "Texture Sampling Parameters") article for more information on the parameters exposed by pressing the + button. The _parameter_ prefix for each of the parameters is _sampler[digit]_. 
...
Extra Information for the GLSL COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
