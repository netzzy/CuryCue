...
See also: [TCP/IP DAT](<./TCP/IP_DAT.md> "TCP/IP DAT")

Example project: [chat with WebSockets](<http://www.derivative.ca/Forum/viewtopic.php?p=30301>)

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[websocketDAT_Class](<./WebsocketDAT_Class.md> "WebsocketDAT Class")
...
Extra Information for the WebSocket DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
