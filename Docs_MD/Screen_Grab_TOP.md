...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[screengrabTOP_Class](</ScreengrabTOP_Class> "ScreengrabTOP Class")
...
Extra Information for the Screen Grab TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
