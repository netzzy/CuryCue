...
The MPCDI DAT lets you load calibration data stored in the MPCDI format. Please refer to the [MPCDI](<./MPCDI.md> "MPCDI") entry for a complete guide on TouchDesigners integration with the MPCDI Standard. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mpcdiDAT_Class](</MpcdiDAT_Class> "MpcdiDAT Class")
...
Extra Information for the MPCDI DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
