...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[renameCHOP_Class](<./RenameCHOP_Class.md> "RenameCHOP Class")
...
See the Rename CHOP for a further description of rename patterns. __
...
Extra Information for the Rename CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
