...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[constantTOP_Class](<./ConstantTOP_Class.md> "ConstantTOP Class")
...
Extra Information for the Constant TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
