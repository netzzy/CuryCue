...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[timemachineTOP_Class](</TimemachineTOP_Class> "TimemachineTOP Class")
...
Extra Information for the Time Machine TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
