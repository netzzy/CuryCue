...
* [Blackmagic Design](<./Blackmagic_Design.md> "Blackmagic Design") devices.
  * [Bluefish444](<./Bluefish444.md> "Bluefish444") devices.
  * [AJA](<./AJA.md> "AJA") devices.
  * [Deltacast](<./Deltacast.md> "Deltacast") devices.


See also [Video Device In TOP](<./Video_Device_In_TOP.md> "Video Device In TOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[videodeviceoutTOP_Class](<./VideodeviceoutTOP_Class.md> "VideodeviceoutTOP Class")
...
Audio CHOP`chop`\- If you want to embed audio data into the output, put the path to a [Time Slice](<./Time_Slicing.md> "Time Slicing") CHOP here. 
...
Audio CHOP`audiochop`\- If you want to embed audio data into the output, put the path to a [Time Sliced](<./Time_Slicing.md> "Time Slicing") CHOP here. 
...
Sync Outputs`syncoutputs`\- **This feature requires a Pro license.** Supported on the [Deltacast](<./Deltacast.md> "Deltacast") FLEX line of cards, and [Blackmagic Design](<./Blackmagic_Design.md> "Blackmagic Design") cards. Blackmagic requires a reference input to be connected. This will cause multiple independent output nodes to stay in sync with each other. Without this then each output will have it's own output queue length which may be off from the other nodes by 1 or 2 frames. Most Blackmagic cards require a Genlock source to be connected for this feature to function as well. 
...
Extra Information for the Video Device Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
