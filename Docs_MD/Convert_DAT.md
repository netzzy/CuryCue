...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[convertDAT_Class](<./ConvertDAT_Class.md> "ConvertDAT Class")
...
Extra Information for the Convert DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
