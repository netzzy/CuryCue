...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[analyzeTOP_Class](<./AnalyzeTOP_Class.md> "AnalyzeTOP Class")
...
Extra Information for the Analyze TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
