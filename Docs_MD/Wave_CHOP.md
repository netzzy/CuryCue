...
The Wave CHOP gives a set of waves in channels of a specifiable time-range. It is superceded by the [LFO CHOP](<./LFO_CHOP.md> "LFO CHOP") which gives an endless stream of waves that is [Time Sliced](</index.php?title=Time_Slice&action=edit&redlink=1> "Time Slice \(page does not exist\)"), and the [Pattern CHOP](<./Pattern_CHOP.md> "Pattern CHOP") that has more control over shaping waveform samples (and is time-independent). The [Audio Oscillator CHOP](<./Audio_Oscillator_CHOP.md> "Audio Oscillator CHOP") also creates waveforms that are continually repeated, but its defaults are for higher-frequency waves at higher (audio) sample rates. 
...
Multiple channels can be generated in the Channel Name parameter using [Pattern Expansion](<./Pattern_Expansion.md> "Pattern Expansion"). A few examples of name pattern name expansion: 

  *`tx ty tz`*`t[xyz]`\- expands to`tx ty tz`*`chan[1-4]`\- expands to`chan1 chan2 chan3 chan4`*`c[xyz][1-5:2]`\- expands to`cx1 cx3 cx5 cy1 cy3 cy5 cz1 cz3 cz5`See also: [LFO CHOP](<./LFO_CHOP.md> "LFO CHOP"), [Pattern CHOP](<./Pattern_CHOP.md> "Pattern CHOP"), [Audio Oscillator CHOP](<./Audio_Oscillator_CHOP.md> "Audio Oscillator CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[waveCHOP_Class](<./WaveCHOP_Class.md> "WaveCHOP Class")
...
* Constant`const`\- [![TouchChannels69.gif](./images/6/6c/TouchChannels69.gif)](</File:TouchChannels69.gif>)(1) A constant-valued "wave".
* Sine`sin`\- [![TouchChannels71.gif](./images/a/ad/TouchChannels71.gif)](</File:TouchChannels71.gif>)(-1 to 1) A Sine wave.
* Gaussian`normal`\- [![TouchChannels74.gif](./images/2/2b/TouchChannels74.gif)](</File:TouchChannels74.gif>)(0 to 1) A Gaussian (also known as a bell or normal) curve.
* Triangle`tri`\- [![TouchChannels76.gif](./images/c/c0/TouchChannels76.gif)](</File:TouchChannels76.gif>)(-1 to 1) A ramp-up to 1 and ramp-down to 0 that can be shaped with the Bias parameter.
* Ramp`ramp`\- [![TouchChannels78.gif](./images/c/cd/TouchChannels78.gif)](</File:TouchChannels78.gif>)(0 to 1) A ramp from 0 to 1.
* Square`square`\- [![TouchChannels80.gif](./images/3/33/TouchChannels80.gif)](</File:TouchChannels80.gif>)(-1 to 1) Step-up/step-down, with Bias control to make it rectangular.
* Pulse`pulse`\- [![TouchChannels82.gif](./images/c/c4/TouchChannels82.gif)](</File:TouchChannels82.gif>)(0 to 1) Produces a 1 for one sample, 0 otherwise.
...
Channel Names`channelname`\- You can creates many channels with simple patterns like "`chan[1-20]`", which generates 20 channels from chan1 to chan20. See the section, Common CHOP Parameters for a description of this and all Options. See [Scope and Channel Name Matching](<./CHOP_Common_Page.htm#Scope> "CHOP Common Page") Options. 
...
Extra Information for the Wave CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
