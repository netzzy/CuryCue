...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[hogCHOP_Class](<./HogCHOP_Class.md> "HogCHOP Class")
...
Extra Information for the Hog CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
