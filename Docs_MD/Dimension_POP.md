...
The Dimension POP can alter the dimensions of a POP. See [Dimension](<./Dimension.md> "Dimension"). 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[dimensionPOP_Class](</DimensionPOP_Class> "DimensionPOP Class")
...
Extra Information for the Dimension POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
