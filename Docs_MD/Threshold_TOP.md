...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[thresholdTOP_Class](</ThresholdTOP_Class> "ThresholdTOP Class")
...
Extra Information for the Threshold TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
