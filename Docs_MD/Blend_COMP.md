...
Note that the effect of the Blend COMP is only visible through a [Camera COMP](<./Camera_COMP.md> "Camera COMP") or the [Render TOP](<./Render_TOP.md> "Render TOP") that is rendering that camera's view. 

See also [Camera Blend COMP](<./Camera_Blend_COMP.md> "Camera Blend COMP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[blendCOMP_Class](<./BlendCOMP_Class.md> "BlendCOMP Class")
...
Extra Information for the Blend COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
