...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mathPOP_Class](</MathPOP_Class> "MathPOP Class")
...
Extra Information for the Math POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
