...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[gestureCHOP_Class](<./GestureCHOP_Class.md> "GestureCHOP Class")
...
* Locked to Timeline`locked`\- This mode locks the gesture position to the [Timeline](<./Timeline.md> "Timeline").
...
Extra Information for the Gesture CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
