...
For more information on writing a shader, see [Write a GLSL Material](<./Write_a_GLSL_Material.md> "Write a GLSL Material"), and the [GLSL Category](<./Category-GLSL.md> "Category:GLSL"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[glslMAT_Class](<./GlslMAT_Class.md> "GlslMAT Class")
...
Refer to the [Texture Sampling Parameters](<./Texture_Sampling_Parameters.md> "Texture Sampling Parameters") article for more information on the parameters exposed by pressing the + button. The _parameter_ prefix for each of the parameters is _top[digit]_. 
...
[Specialization Constants](<./Write_a_GLSL_Material.htm#Specialization_Constants> "Write a GLSL Material") can optionally have their values assigned here. 
...
Extra Information for the GLSL MAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
