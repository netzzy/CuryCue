...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[differenceTOP_Class](<./DifferenceTOP_Class.md> "DifferenceTOP Class")
...
Extra Information for the Difference TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
