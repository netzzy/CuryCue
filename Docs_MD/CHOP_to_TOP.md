...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[choptoTOP_Class](<./ChoptoTOP_Class.md> "ChoptoTOP Class")
...
Extra Information for the CHOP to TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
