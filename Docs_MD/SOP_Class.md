...
A [SOP](<./SOP.md> "SOP") describes a reference to a SOP operator, containing [points](<./Points_Class.md> "Points Class") and [primitives](<./Prims_Class.md> "Prims Class"). 
...
> 
>   * display - (Keyword, Optional) If set to True, only SOP operators whose[ display flag](<./Display_Flag.md> "Display Flag") are turned on are included in the calculation. When False, the states of the display flag is ignored.
>   * render - (Keyword, Optional) If set to True, only SOP operators whose[ render flag](<./Render_Flag.md> "Render Flag") are turned on are included in the calculation. When False, the state of the render flag is ignored.
...
TouchDesigner Build: Latest\nwikieditorwikieditorwikieditor2025.300002022.241402021.100002020.200002018.28070before 2018.28070
