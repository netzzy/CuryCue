...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Geometry COMP](<./Geometry_COMP.md> "Geometry COMP").   
  
## Members

No operator specific members. 

## Methods`bounds(display=False, render=False, selected=False, recurse=True)`→`Tuple[Tuple[float, float, float], Tuple[float, float, float], Tuple[float, float, float], Tuple[float, float, float]]`: 
...
> 
>   * display - (Keyword, Optional) If set to True, only [SOP](<./SOP_Class.md> "SOP Class") and [POP](<./POP_Class.md> "POP Class") operators whose[ display flag](<./Display_Flag.md> "Display Flag") are turned on are included in the calculation. Furthermore, if the SOP or POP is contained within a child Geometry Component, that operator must have its display flag turned on as well.
>   * render - (Keyword, Optional) If set to True, only [SOP](<./SOP_Class.md> "SOP Class") and [POP](<./POP_Class.md> "POP Class") operators whose[ render flag](<./Render_Flag.md> "Render Flag") set are included in the calculation. Furthermore, if the SOP or POP is contained within a child Geometry Component, that operator must have its render flag set as well.
>   * selected - (Keyword, Optional) If set to True, only child [components](<./COMP_Class.md> "COMP Class") that are currently selected are included in the calculation.
...
## Members`localTransform`→`tdu.Matrix`**(Read Only)** : 

> The current local transform of the Object. This is the combination of both the parameters from the Xform and Pre-Xform page, without taking into account any parent or constraint transforms. See also [Matrix Class](<./Matrix_Class.md> "Matrix Class"), [Position Class](<./Position_Class.md> "Position Class") and [Vector Class](<./Vector_Class.md> "Vector Class").`worldTransform`→`tdu.Matrix`**(Read Only)** : 

> The current world transform of the Object.

## Methods`transform()`→`tdu.Matrix`: 

> Gets the current transform of the Object as defined by the Translate, Rotate, Scale and Pivot parameters on the Xform page.`setTransform(matrix)`→`None`: 
...
> Gets the current transform of the Object as defined by the Translate, Rotate, Scale and Pivot parameters on the Pre-Xform page.`setPreTransform(matrix)`→`None`: 
...
> 
>   * target - The target [ObjectCOMP](<./ObjectCOMP_Class.md> "ObjectCOMP Class"). See also [Matrix Class](<./Matrix_Class.md> "Matrix Class"), [Position Class](<./Position_Class.md> "Position Class") and [Vector Class](<./Vector_Class.md> "Vector Class").
