# Palette:cornerPinPOP

##   
  
Summary

The Corner Pin POP component allows for perspective or bilinear deformation of a POP. It can be best compared in functionality to the Corner Pin TOP. It uses [OpenCV's](<./OpenCV.md> "OpenCV")`.findHomography()`function to calculate the perspective transform matrix. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:cornerPinPOP Ext](<./Palette-cornerPinPOP_Ext.md> "Palette:cornerPinPOP Ext")
...
.tox Save Build`Toxsavebuild`\- The TouchDesigner build this component was saved in. 
