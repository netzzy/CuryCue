...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[blurTOP_Class](<./BlurTOP_Class.md> "BlurTOP Class")
...
Extra Information for the Blur TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
