...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[linebreakPOP_Class](</LinebreakPOP_Class> "LinebreakPOP Class")
...
Extra Information for the Line Break POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
