...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[primitivePOP_Class](<./PrimitivePOP_Class.md> "PrimitivePOP Class")
...
Extra Information for the Create POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
