...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[polystitchSOP_Class](<./PolystitchSOP_Class.md> "PolystitchSOP Class")
...
Extra Information for the Polystitch SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
