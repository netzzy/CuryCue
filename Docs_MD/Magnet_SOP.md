...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[magnetSOP_Class](<./MagnetSOP_Class.md> "MagnetSOP Class")

## 

Parameters - Page

Deform Group`deformgrp`\- Allows you to specify a group of geometry to be deformed, and a group that will act as the magnet respectively. Accepts patterns, as described in [Pattern Matching](<./Pattern_Matching.md> "Pattern Matching"). 

Magnet Group`magnetgrp`\- Allows you to specify a group of geometry to be deformed, and a group that will act as the magnet respectively. Accepts patterns, as described in [Pattern Matching](<./Pattern_Matching.md> "Pattern Matching"). 
...
The scale and rotate channels of the magnet move you about in 3D color space. This is not recommended. __
...
Extra Information for the Magnet SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
