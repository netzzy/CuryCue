...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cropTOP_Class](<./CropTOP_Class.md> "CropTOP Class")
...
Extra Information for the Crop TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
