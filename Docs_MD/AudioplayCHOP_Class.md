...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Play CHOP](<./Audio_Play_CHOP.md> "Audio Play CHOP"). 

## Members

No operator specific members. 

## Methods`play(index, start=True, loop=False, delaySeconds=0.0, pan=None, rolloff=None, volume=None, fadeSeconds=0.0)`→`None`: 
