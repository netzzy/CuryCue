...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[recordCHOP_Class](<./RecordCHOP_Class.md> "RecordCHOP Class")
...
* Current Time Slice`slice`\- Outputs the current [Time Slice](</index.php?title=Time_Slice&action=edit&redlink=1> "Time Slice \(page does not exist\)") of samples only.
...
Extra Information for the Record CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
