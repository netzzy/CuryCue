...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[facetSOP_Class](<./FacetSOP_Class.md> "FacetSOP Class")
...
Usually very small numbers, such as`0.01`should be used here. If the value is`0.0`, then points must be in exactly the same position (co-incident) in order to be considered for the consolidation/averaging function. __
...
Extra Information for the Facet SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
