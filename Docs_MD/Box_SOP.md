...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[boxSOP_Class](<./BoxSOP_Class.md> "BoxSOP Class")
...
Extra Information for the Box SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
