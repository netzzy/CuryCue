...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio File Out CHOP](<./Audio_File_Out_CHOP.md> "Audio File Out CHOP"). 

## Members`fileSuffix`→ **(Read Only)** : 
...
TouchDesigner Build: Latest\n2025.300002022.241402021.100002020.20000before 2020.20000
