...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[normalPOP_Class](</NormalPOP_Class> "NormalPOP Class")
...
Extra Information for the Normal POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
