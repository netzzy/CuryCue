...
See also [Nvidia Flow TOP](<./Nvidia_Flow_TOP.md> "Nvidia Flow TOP"), [Nvidia Flow](<./Nvidia_Flow.md> "Nvidia Flow"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[flowEmitterCOMP_Class](</FlowEmitterCOMP_Class> "FlowEmitterCOMP Class")
...
The effect of this parameter can be visualized by turning 'Show Blocks' parameter On in the [Nvidia Flow TOP](<./Nvidia_Flow_TOP.md> "Nvidia Flow TOP"). __
...
Extra Information for the Nvidia Flow Emitter COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
