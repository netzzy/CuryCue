...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[layerTOP_Class](</LayerTOP_Class> "LayerTOP Class")
...
Extra Information for the Layer TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
