...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[flipTOP_Class](<./FlipTOP_Class.md> "FlipTOP Class")
...
Extra Information for the Flip TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
