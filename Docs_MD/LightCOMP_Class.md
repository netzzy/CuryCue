...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Light COMP](<./Light_COMP.md> "Light COMP"). 

## Members

No operator specific members. 

## Methods`projectionInverse(x, y)`→`tdu.Matrix`: 
...
> Returns the projection [matrix](<./Matrix_Class.md> "Matrix Class") for the light's view, given the X and Y aspect. In general these would be set to the width and height of your render. 
> 
>   * x - The horizontal aspect ratio.
>   * y - The vertical aspect ratio.
> 
...
>     
[/code]`mpcdiRegion(width, height)`→`dict`: 
