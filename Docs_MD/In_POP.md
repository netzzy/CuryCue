...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inPOP_Class](</InPOP_Class> "InPOP Class")
...
Extra Information for the In POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
