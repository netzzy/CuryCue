...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[overrideCHOP_Class](<./OverrideCHOP_Class.md> "OverrideCHOP Class")
...
Extra Information for the Override CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
