...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inCHOP_Class](<./InCHOP_Class.md> "InCHOP Class")
...
Extra Information for the In CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
