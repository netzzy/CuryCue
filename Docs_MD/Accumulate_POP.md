...
You can check it all with a [POP to DAT](<./POP_to_DAT.md> "POP to DAT"). 

See also: [Analyze POP](<./Analyze_POP.md> "Analyze POP"), [Histogram POP](<./Histogram_POP.md> "Histogram POP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[accumulatePOP_Class](</AccumulatePOP_Class> "AccumulatePOP Class")
...
Extra Information for the Accumulate POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
