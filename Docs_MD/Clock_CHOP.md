...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[clockCHOP_Class](<./ClockCHOP_Class.md> "ClockCHOP Class")
...
Extra Information for the Clock CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
