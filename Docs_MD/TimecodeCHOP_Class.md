...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Timecode CHOP](<./Timecode_CHOP.md> "Timecode CHOP"). 

## Members`timecode`→ **(Read Only)** : 

> Get a Timecode object representing the timecode data of the Timecode CHOP. See [Timecode Class](<./Timecode_Class.md> "Timecode Class").
