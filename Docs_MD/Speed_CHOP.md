...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[speedCHOP_Class](<./SpeedCHOP_Class.md> "SpeedCHOP Class")
...
Extra Information for the Speed CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
