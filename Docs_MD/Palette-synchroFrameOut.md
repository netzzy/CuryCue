...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:synchroFrameOut Ext](</index.php?title=Palette:synchroFrameOut_Ext&action=edit&redlink=1> "Palette:synchroFrameOut Ext \(page does not exist\)")
