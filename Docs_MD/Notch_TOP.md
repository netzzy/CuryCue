...
See also: [Notch](<./Notch.md> "Notch")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[notchTOP_Class](<./NotchTOP_Class.md> "NotchTOP Class")
...
Extra Information for the Notch TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
