...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[limitTOP_Class](</LimitTOP_Class> "LimitTOP Class")
...
Extra Information for the Limit TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
