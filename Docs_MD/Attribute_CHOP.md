...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[attributeCHOP_Class](<./AttributeCHOP_Class.md> "AttributeCHOP Class")
...
Extra Information for the Attribute CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
