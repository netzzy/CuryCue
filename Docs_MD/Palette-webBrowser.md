...
The`webBrowser`component in the palette is an interactive interface to the [Web Render TOP](<./Web_Render_TOP.md> "Web Render TOP"). It is currently available on Windows only, in the Commercial, Educational and Pro versions of TouchDesigner.`webBrowser`and the [Web Render TOP](<./Web_Render_TOP.md> "Web Render TOP") is the Chromium project underneath, with the CEF (Chromium Embedded Framework) wrapper providing the interface to the`webBrowser`and the [Web Render TOP](<./Web_Render_TOP.md> "Web Render TOP"). 
...
See also [Web Render TOP](<./Web_Render_TOP.md> "Web Render TOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:webBrowser Ext](</index.php?title=Palette:webBrowser_Ext&action=edit&redlink=1> "Palette:webBrowser Ext \(page does not exist\)")
...
Active`Active`\- Enables/disables the [Web Render TOP](<./Web_Render_TOP.md> "Web Render TOP"). 
