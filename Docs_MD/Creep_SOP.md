...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[creepSOP_Class](<./CreepSOP_Class.md> "CreepSOP Class")
...
Extra Information for the Creep SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
