...
See also [Deforming Geometry (Skinning)](<./Deforming_Geometry_\(Skinning\).md> "Deforming Geometry \(Skinning\)"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[deformSOP_Class](<./DeformSOP_Class.md> "DeformSOP Class")

## 

Parameters - Page

Group`group`\- Optional point and/or primitive group to be deformed. Accepts patterns, as described in [Pattern Matching](<./Pattern_Matching.md> "Pattern Matching"). 
...
Extra Information for the Deform SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
