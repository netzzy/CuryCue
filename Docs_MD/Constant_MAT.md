...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[constantMAT_Class](<./ConstantMAT_Class.md> "ConstantMAT Class")

## 

Parameters - Constant Page

Apply Projection Maps`applyprojmaps`\- The projection map texture color from a [Light COMP](<./Light_COMP.md> "Light COMP") will be applied to the object as well. This allows for applying a projection map without affecting the projection map's color with any lighting. 
...
Extra Information for the Constant MAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
