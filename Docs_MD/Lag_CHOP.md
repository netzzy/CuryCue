...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lagCHOP_Class](<./LagCHOP_Class.md> "LagCHOP Class")
...
Extra Information for the Lag CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
