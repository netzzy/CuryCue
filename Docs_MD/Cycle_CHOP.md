...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cycleCHOP_Class](<./CycleCHOP_Class.md> "CycleCHOP Class")
...
Extra Information for the Cycle CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
