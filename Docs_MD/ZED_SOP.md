...
The ZED SOP uses the ZED to scan and create geometry by moving it around the room or an object of interest. To know what ZED SDK we are using, refer to the [ZED](<./ZED.md> "ZED") article. 

See [ZED TOP](<./ZED_TOP.md> "ZED TOP"), [ZED CHOP](<./ZED_CHOP.md> "ZED CHOP"), [ZED POP](<./ZED_POP.md> "ZED POP") and [ZED](<./ZED.md> "ZED"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[zedSOP_Class](<./ZedSOP_Class.md> "ZedSOP Class")

## 

Parameters - Page

ZED TOP`zedtop`\- The name of the primary [ZED TOP](<./ZED_TOP.md> "ZED TOP") that is configuring the camera. The primary TOP controls which camera the SOP receives data from. 
...
Extra Information for the ZED SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
