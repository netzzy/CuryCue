...
See also the [OP Snippets](<./OP_Snippets.md> "OP Snippets"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[phaserCHOP_Class](</PhaserCHOP_Class> "PhaserCHOP Class")
...
Extra Information for the Phaser CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
