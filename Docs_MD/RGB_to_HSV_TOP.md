...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[rgbtohsvTOP_Class](</RgbtohsvTOP_Class> "RgbtohsvTOP Class")
...
Extra Information for the RGB to HSV TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
