...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cornerpinTOP_Class](<./CornerpinTOP_Class.md> "CornerpinTOP Class")
...
Extra Information for the Corner Pin TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
