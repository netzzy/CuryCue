...
You can use [Pattern Expansion](<./Pattern_Expansion.md> "Pattern Expansion") like`geo[1-4][xyz]`to generate multiple channels in one line. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[constantCHOP_Class](<./ConstantCHOP_Class.md> "ConstantCHOP Class")
...
in the first channel field instead of "`chan1`". See [Pattern Expansion](<./Pattern_Expansion.md> "Pattern Expansion"), [Pattern Matching](<./Pattern_Matching.md> "Pattern Matching"). 
...
You can simulate the pressing of the Snapshot Input button from a script. To simulate the clicking of a CHOP dialog box button from a script use the [Par Class](<./Par_Class.md> "Par Class") pulse() Method: 
...
Extra Information for the Constant CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
