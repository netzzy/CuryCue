...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[gridSOP_Class](<./GridSOP_Class.md> "GridSOP Class")
...
Extra Information for the Grid SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
