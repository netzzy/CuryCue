...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[crossCHOP_Class](<./CrossCHOP_Class.md> "CrossCHOP Class")
...
Extra Information for the Cross CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
