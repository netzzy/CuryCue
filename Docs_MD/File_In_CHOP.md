...
For a complete listing of all valid formats for CHOPs, see the [File Types](<./File_Types.md> "File Types") section. The types of files that can be read into CHOPs include: 
...
The same files can be output from the [RMB](<./Mouse_Click.md> "Mouse Click") menu on the CHOP by selecting **Save Data Channels**. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fileinCHOP_Class](<./FileinCHOP_Class.md> "FileinCHOP Class")
...
Extra Information for the File In CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
