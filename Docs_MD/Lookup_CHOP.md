...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lookupCHOP_Class](<./LookupCHOP_Class.md> "LookupCHOP Class")
...
Extra Information for the Lookup CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
