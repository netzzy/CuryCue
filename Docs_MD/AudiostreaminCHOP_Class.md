...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Stream In CHOP](<./Audio_Stream_In_CHOP.md> "Audio Stream In CHOP"). 
