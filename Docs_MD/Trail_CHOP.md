...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[trailCHOP_Class](<./TrailCHOP_Class.md> "TrailCHOP Class")
...
Extra Information for the Trail CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
