...
The SOP to CHOP uses a [geometry object](<./Geometry_COMP.md> "Geometry COMP") to choose a [SOP](<./SOP.md> "SOP") from which the channels will be created. The channels are created from the point attributes of a SOP, such as the X, Y and Z of the point position. 
...
For data going the opposite direction, see the [Channel SOP](<./CHOP_to_SOP.md> "CHOP to SOP"). 

**Note:** This CHOP works in tandem with the [Channel SOP](<./CHOP_to_SOP.md> "CHOP to SOP"). Point data is modified in CHOPs as regular channel data (samples) and then fed back to geometry as point attributes through the Channel SOP. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[soptoCHOP_Class](<./SoptoCHOP_Class.md> "SoptoCHOP Class")
...
See [Attributes](<./Attribute.md> "Attribute") for a complete list of attributes. __
...
Extra Information for the SOP to CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
