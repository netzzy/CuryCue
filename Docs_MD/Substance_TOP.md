...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[substanceTOP_Class](<./SubstanceTOP_Class.md> "SubstanceTOP Class")
...
Extra Information for the Substance TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
