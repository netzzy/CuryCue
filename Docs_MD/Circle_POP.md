...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[circlePOP_Class](</CirclePOP_Class> "CirclePOP Class")
...
Extra Information for the Circle POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
