...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[springCHOP_Class](</SpringCHOP_Class> "SpringCHOP Class")
...
Extra Information for the Spring CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
