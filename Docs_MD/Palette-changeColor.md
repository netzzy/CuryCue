...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:changeColor Ext](</index.php?title=Palette:changeColor_Ext&action=edit&redlink=1> "Palette:changeColor Ext \(page does not exist\)")
