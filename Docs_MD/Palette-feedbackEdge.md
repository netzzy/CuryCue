...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:feedbackEdge Ext](</index.php?title=Palette:feedbackEdge_Ext&action=edit&redlink=1> "Palette:feedbackEdge Ext \(page does not exist\)")
