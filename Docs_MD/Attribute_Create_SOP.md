...
See also [Normal Mapping](<./Normal_Mapping.md> "Normal Mapping"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[attributecreateSOP_Class](<./AttributecreateSOP_Class.md> "AttributecreateSOP Class")
...
Extra Information for the Attribute Create SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
