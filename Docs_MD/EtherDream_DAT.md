...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[etherdreamDAT_Class](<./EtherdreamDAT_Class.md> "EtherdreamDAT Class")

## 

Parameters - EtherDream Page

Callbacks DAT`callbacks`\- Runs this script when polling for devices. See [etherdreamDAT_Class](<./EtherdreamDAT_Class.md> "EtherdreamDAT Class") for usage. 
...
Extra Information for the EtherDream DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
