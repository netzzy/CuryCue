...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Sync In CHOP](<./Sync_In_CHOP.md> "Sync In CHOP").   
  
## Members`timecode`→`tdu.Timecode`**(Read Only)** : 

> Get a Timecode object for the timecode data representation of the last received index. See [Timecode Class](<./Timecode_Class.md> "Timecode Class").
