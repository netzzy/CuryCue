...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sprinkleSOP_Class](</SprinkleSOP_Class> "SprinkleSOP Class")
...
Extra Information for the Sprinkle SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
