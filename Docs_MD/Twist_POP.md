...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[twistPOP_Class](</TwistPOP_Class> "TwistPOP Class")
...
Extra Information for the Twist POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
