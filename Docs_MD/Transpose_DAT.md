...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[transposeDAT_Class](</TransposeDAT_Class> "TransposeDAT Class")
...
Extra Information for the Transpose DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
