...
The Julia COMP is a mapping of the Julia fractal set, more information about the Julia set can be found [here](<https://en.wikipedia.org/wiki/Julia_set>). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:julia Ext](</index.php?title=Palette:julia_Ext&action=edit&redlink=1> "Palette:julia Ext \(page does not exist\)")

## 

Parameters - Julia Page
...
Center`Center`\- ⊞ \- Coordinates of the center of the shape. 
* Center`Centerx`-
* Center`Centery`-


Scale`Scale`\- Adjust the size of the shape. 

Iterations`Iter`\- The number of times the Julia set is calculated. 

Increment`Increment`\- 

Iteration Limits`Iterlimit`\- ⊞ \- 
* Iteration Limits`Iterlimit1`-
* Iteration Limits`Iterlimit2`-
