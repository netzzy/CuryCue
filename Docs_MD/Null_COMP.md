...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nullCOMP_Class](<./NullCOMP_Class.md> "NullCOMP Class")
...
Extra Information for the Null COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
