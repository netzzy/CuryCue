...
This class inherits from the [ TOP class](<./TOP_Class.md> "TOP Class"). It references a specific [Nvidia Background TOP](<./Nvidia_Background_TOP.md> "Nvidia Background TOP").   
