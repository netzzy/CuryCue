...
See [Using Shared Memory in TouchDesigner](<./Using_Shared_Memory_in_TouchDesigner.md> "Using Shared Memory in TouchDesigner") and [Shared Mem In TOP](<./Shared_Mem_In_TOP.md> "Shared Mem In TOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sharedmemoutTOP_Class](</SharedmemoutTOP_Class> "SharedmemoutTOP Class")
...
Extra Information for the Shared Mem Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
