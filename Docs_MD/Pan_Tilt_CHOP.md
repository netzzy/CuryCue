...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[pantiltCHOP_Class](<./PantiltCHOP_Class.md> "PantiltCHOP Class")
...
Extra Information for the Pan Tilt CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
