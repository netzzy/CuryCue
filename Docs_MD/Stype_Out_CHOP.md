...
The channels used by the Stype Out CHOP are: 
    ...
    _packet_number_ \- a looping number from 0-255 indicating the packet number. By default the number is incremented each frame, but can also be generated manually (see Stype protocol for more information)
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[stypeoutCHOP_Class](</StypeoutCHOP_Class> "StypeoutCHOP Class")
