...
Therefore any CHOPs after the Time Slice CHOP, like Gesture, Record or [Lag CHOP](<./Lag_CHOP.md> "Lag CHOP") will get smooth data going into it, even though TouchDesigner isn't cooking every frame. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[timesliceCHOP_Class](</TimesliceCHOP_Class> "TimesliceCHOP Class")
...
Extra Information for the Time Slice CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
