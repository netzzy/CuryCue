...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[touchinDAT_Class](</TouchinDAT_Class> "TouchinDAT Class")
...
Extra Information for the Touch In DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
