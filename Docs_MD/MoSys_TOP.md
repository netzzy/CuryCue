...
The MoSys TOP works with [MoSys](<./MoSys.md> "MoSys") camera tracking systems to perform simulated lens distortion using channels from a connected [MoSys CHOP](<./MoSys_CHOP.md> "MoSys CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mosysTOP_Class](</MosysTOP_Class> "MosysTOP Class")
