...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[channelmixTOP_Class](<./ChannelmixTOP_Class.md> "ChannelmixTOP Class")
...
Extra Information for the Channel Mix TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
