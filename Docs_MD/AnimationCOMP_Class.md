...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Animation COMP](<./Animation_COMP.md> "Animation COMP").   
  
## Members

No operator specific members. 

## Methods`setKeyframe(position, channel='*', value=None, function=None)`→`None`: 
