...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fileoutCHOP_Class](<./FileoutCHOP_Class.md> "FileoutCHOP Class")
...
Extra Information for the File Out CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
