...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sortDAT_Class](</SortDAT_Class> "SortDAT Class")
...
Extra Information for the Sort DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
