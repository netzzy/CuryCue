...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[leuzerod4CHOP_Class](<./Leuzerod4CHOP_Class.md> "Leuzerod4CHOP Class")
...
Extra Information for the Leuze ROD4 CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
