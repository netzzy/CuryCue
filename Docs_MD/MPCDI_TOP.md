...
The MPCDI TOP lets you load calibration data stored in the MPCDI format. Please refer to the [MPCDI](<./MPCDI.md> "MPCDI") entry for a complete guide on TouchDesigners integration with the MPCDI Standard. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mpcdiTOP_Class](</MpcdiTOP_Class> "MpcdiTOP Class")
...
Extra Information for the MPCDI TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
