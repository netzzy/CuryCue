...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[selectTOP_Class](</SelectTOP_Class> "SelectTOP Class")
...
Extra Information for the Select TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
