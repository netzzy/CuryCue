...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Movie CHOP](<./Audio_Movie_CHOP.md> "Audio Movie CHOP"). 

## Members`hasAudio`→`bool`**(Read Only)** : 

> True if the movie has audio.`playbackRate`→`float`**(Read Only)** : 
