...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[kinectSOP_Class](<./KinectSOP_Class.md> "KinectSOP Class")
...
Extra Information for the Kinect SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
