...
See also [Splice CHOP](<./Splice_CHOP.md> "Splice CHOP"), [Delete CHOP](<./Delete_CHOP.md> "Delete CHOP"), [Select CHOP](<./Select_CHOP.md> "Select CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[trimCHOP_Class](<./TrimCHOP_Class.md> "TrimCHOP Class")
...
Extra Information for the Trim CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
