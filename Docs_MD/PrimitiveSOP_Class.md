...
> The current primitive color being evaluated or a default if not present, expressed as a 4-tuple (r, g, b, a).`inputPrim`→`Prim`**(Read Only)** : 

> The current [primitive](<./Prim_Class.md> "Prim Class") being evaluated.
