...
You can add strings that will be put in the new cells, space separated. If you want a cell to include spaces, in the Contents parameter put the cell contents in quotes:`cell1 'cell 2' cell3`. Or a list in the parameter expression:`['cell1', 'cell 2']`If the input DAT is not a table, it will be converted to a table. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[insertDAT_Class](<./InsertDAT_Class.md> "InsertDAT Class")
...
Extra Information for the Insert DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
