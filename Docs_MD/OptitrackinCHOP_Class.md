...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [OptiTrack In CHOP](<./OptiTrack_In_CHOP.md> "OptiTrack In CHOP"). 
...
TouchDesigner Build: Latest\nwikieditormw-removed-redirectmw-new-redirect2025.30000
