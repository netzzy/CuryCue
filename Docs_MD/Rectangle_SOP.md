...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[rectangleSOP_Class](<./RectangleSOP_Class.md> "RectangleSOP Class")
...
Extra Information for the Rectangle SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
