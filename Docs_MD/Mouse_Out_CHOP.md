...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mouseoutCHOP_Class](<./MouseoutCHOP_Class.md> "MouseoutCHOP Class")
...
Extra Information for the Mouse Out CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
