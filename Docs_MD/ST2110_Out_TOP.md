...
To obtain the SDPs generated for the output essences, use an [Info DAT](<./Info_DAT.md> "Info DAT") and choose which SDP to obtain. 

See also [ST2110 In TOP](<./ST2110_In_TOP.md> "ST2110 In TOP"), [ST2110 Device CHOP](<./ST2110_Device_CHOP.md> "ST2110 Device CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[st2110outTOP_Class](<./St2110outTOP_Class.md> "St2110outTOP Class")
...
Timecode Object/CHOP/DAT`timecodeop`\- For devices that support timecode, this can point to a [Timecode](<./Timecode.md> "Timecode") source to send over the ancillary essence. 
...
Extra Information for the ST2110 Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
