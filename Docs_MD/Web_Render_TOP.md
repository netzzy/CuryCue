...
Attach an [Info CHOP](<./Info_CHOP.md> "Info CHOP") to get the loaded status`loaded`of the page, and`num_handle_updates`, the number of times the page has been rendered. 

Attach an [Info DAT](<./Info_DAT.md> "Info DAT") to get the shared memory`handle`, the`status`of the browser process, the`process_id`, versions for Chromium Embedded Frameworks`cef`and Chromium`chromium`, the`url`currently displayed, page`title`and`error`state of the process. 

See also [Palette:webBrowser](<./Palette-webBrowser.md> "Palette:webBrowser"), [Audio Web Render CHOP](<./Audio_Web_Render_CHOP.md> "Audio Web Render CHOP"), [Palette:SVG](<./Palette-SVG.md> "Palette:SVG")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[webrenderTOP_Class](<./WebrenderTOP_Class.md> "WebrenderTOP Class")
...
Extra Information for the Web Render TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
