...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[objectmergeSOP_Class](<./ObjectmergeSOP_Class.md> "ObjectmergeSOP Class")
...
Extra Information for the Object Merge SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
