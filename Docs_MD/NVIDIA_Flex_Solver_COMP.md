...
See also: [Flex](<./Flex.md> "Flex"), [Nvidia Flex TOP](<./Nvidia_Flex_TOP.md> "Nvidia Flex TOP"), [Actor COMP](<./Actor_COMP.md> "Actor COMP"), [Force COMP](<./Force_COMP.md> "Force COMP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nvidiaflexsolverCOMP_Class](<./NvidiaflexsolverCOMP_Class.md> "NvidiaflexsolverCOMP Class")
...
Pre-Roll`preroll`\- Enables simulation pre-roll. Pre-roll can used to step forward the simulation to a desired start state. Pre-roll will happen during the initialization phase. To get info on the state of pre-roll, see the channels on the Solver's [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
...
Enable Diffuse Particles`diffuse`\- When enabled, diffuse particles will be created in the simulation. Diffuse particle position/velocity can be fetched using the [Nvidia Flex TOP](<./Nvidia_Flex_TOP.md> "Nvidia Flex TOP"). 
...
Extra Information for the Nvidia Flex Solver COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
