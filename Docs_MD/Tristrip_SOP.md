...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[tristripSOP_Class](</TristripSOP_Class> "TristripSOP Class")
...
Extra Information for the Tristrip SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
