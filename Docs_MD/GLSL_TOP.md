...
The GLSL TOP can act as a pixel shader, or the more general and complex [Compute Shader](<./Compute_Shader.md> "Compute Shader"). Caveat: Compute Shaders need GLSL 4.30 or later. 
...
**Refer to the[Write a GLSL TOP](<./Write_a_GLSL_TOP.md> "Write a GLSL TOP") article for more info on using this TOP.**   
  
See the [GLSL Category](<./Category-GLSL.md> "Category:GLSL") for more information, and [Compute Shader](<./Compute_Shader.md> "Compute Shader"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[glslTOP_Class](<./GlslTOP_Class.md> "GlslTOP Class")
...
This page allows you to pass entire attribute buffers from POPs into the shader. A function is declared to access each attribute buffer, see [POP Attributes](<./Write_a_GLSL_TOP.htm#POP_Attributes> "Write a GLSL TOP") for syntax. 
...
Extra Information for the GLSL TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
