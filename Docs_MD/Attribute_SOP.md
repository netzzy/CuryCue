...
For example:`Cd Alpha`[Pattern Matching](<./Pattern_Matching.md> "Pattern Matching") \- Deletion accepts general pattern matching when determining which attributes to delete. For example: 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[attributeSOP_Class](<./AttributeSOP_Class.md> "AttributeSOP Class")
...
Extra Information for the Attribute SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
