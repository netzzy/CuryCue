...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[infoDAT_Class](<./InfoDAT_Class.md> "InfoDAT Class")

## 

Parameters - Info Page

Operator`op`\- The [path](<./Network_Path.md> "Network Path") to the operator that the Info DAT is getting information from. You can drag & drop any node onto this path, or type the path directly into the field. 
...
Extra Information for the Info DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
