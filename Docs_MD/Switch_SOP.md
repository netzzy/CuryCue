...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[switchSOP_Class](</SwitchSOP_Class> "SwitchSOP Class")
...
Extra Information for the Switch SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
