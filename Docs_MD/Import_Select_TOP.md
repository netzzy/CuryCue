...
The Import Select TOP loads the texture map images such as Color Map, Normal Map, Metallic Map and so forth that are defined in [FBX COMP](<./FBX_COMP.md> "FBX COMP") or [USD COMP](<./USD_COMP.md> "USD COMP"). The image binaries can be encoded within the importing file (e.g. .usdz format) or specified as an external asset with an valid path. 

See also: [FBX COMP](<./FBX_COMP.md> "FBX COMP"), [USD COMP](<./USD_COMP.md> "USD COMP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[importselectTOP_Class](</ImportselectTOP_Class> "ImportselectTOP Class")
...
Extra Information for the Import Select TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
