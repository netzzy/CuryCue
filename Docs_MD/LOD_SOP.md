...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lodSOP_Class](<./LodSOP_Class.md> "LodSOP Class")
...
Extra Information for the LOD SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
