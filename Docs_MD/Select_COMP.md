...
The Select component selects a [Panel Component](<./Panel_Component.md> "Panel Component") from any other location. This allows a panel to appear in multiple other panels. Note that the Select component does not support child panels ie. through its output connector or embedded panels. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[selectCOMP_Class](</SelectCOMP_Class> "SelectCOMP Class")

## 

Parameters - Select Page

Select Panel`selectpanel`\- The [Panel](<./Panel.md> "Panel") Component which is being selected. 
...
Extra Information for the Select COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
