...
A [CHOP](<./CHOP.md> "CHOP") describes a reference to a CHOP operator, containing a set of [channels](<./Channel.md> "Channel") accessed with the [Channel Class](<./Channel_Class.md> "Channel Class"). 
