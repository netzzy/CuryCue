...
The Leap Motion TOP gets the image from the [Leap Motion](<./Leap_Motion.md> "Leap Motion") controller's cameras. To enable this feature the option **Allow Images** must be turned on in the Leap Motion Control Panel. 
...
See also [Leap Motion](<./Leap_Motion.md> "Leap Motion"), [Leap Motion CHOP](<./Leap_Motion_CHOP.md> "Leap Motion CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[leapmotionTOP_Class](<./LeapmotionTOP_Class.md> "LeapmotionTOP Class")
...
For Gemini V5, first install the tracking software, then set this parameter to C:\Program Files\Ultraleap\LeapSDK\lib\x64 where it will find the LeapC.dll file. __
...
Extra Information for the Leap Motion TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
