...
See [Write a CPlusPlus Plugin](<./Write_a_CPlusPlus_Plugin.md> "Write a CPlusPlus Plugin"), [Write a CPlusPlus POP](<./Write_a_CPlusPlus_POP.md> "Write a CPlusPlus POP") and the other articles in the [ C++ Category](<./Category-C++.md> "Category:C++") for more detailed information on how to make plugins for use with this node and how to access example projects. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cplusplusPOP_Class](<./CplusplusPOP_Class.md> "CplusplusPOP Class")
...
Extra Information for the CPlusPlus POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
