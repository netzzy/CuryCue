...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lineSOP_Class](<./LineSOP_Class.md> "LineSOP Class")
...
Extra Information for the Line SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
