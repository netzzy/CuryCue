...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[interpolateCHOP_Class](<./InterpolateCHOP_Class.md> "InterpolateCHOP Class")
...
Extra Information for the Interpolate CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
