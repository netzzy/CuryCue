...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [LTC In CHOP](<./LTC_In_CHOP.md> "LTC In CHOP"). 

## Members`timecode`→`tdu.Timecode`**(Read Only)** : 

> Get a Timecode object for the timecode data representation of the LTC In CHOP. See [Timecode Class](<./Timecode_Class.md> "Timecode Class").
