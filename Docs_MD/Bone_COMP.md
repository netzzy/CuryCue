...
The Bone Component is the foundation of all of the [Character Tools](</Character_Tools> "Character Tools"). It is a Component with most of the properties of a [Geometry Component](<./Geometry_COMP.md> "Geometry COMP"). It also has some extra features such as length, two types of geometry, end-to-end linking, and kinematic parameters. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[boneCOMP_Class](<./BoneCOMP_Class.md> "BoneCOMP Class")
...
The Capture page is used to automatically create a capture region used by either the Capture or Deform sops (see [Capture SOP](<./Capture_SOP.md> "Capture SOP") and [Deform SOP](<./Deform_SOP.md> "Deform SOP") of the SOPs section). The capture region consists of at least two ellipses, and they may be translated along the bone's length. 
...
Extra Information for the Bone COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
