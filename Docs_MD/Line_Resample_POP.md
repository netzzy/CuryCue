...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lineresamplePOP_Class](<./LineresamplePOP_Class.md> "LineresamplePOP Class")
...
Extra Information for the Line Resample POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
