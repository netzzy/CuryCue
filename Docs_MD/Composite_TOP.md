...
**Note:** See also the [blendModes component](<./Palette-blendModes.md> "Palette:blendModes") in the Palette. Refer also to [OP Snippets](<./OP_Snippets.md> "OP Snippets"). 

**Note:** This TOP supports 3D Textures and 2D Texture Arrays. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[compositeTOP_Class](<./CompositeTOP_Class.md> "CompositeTOP Class")
...
Extra Information for the Composite TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
