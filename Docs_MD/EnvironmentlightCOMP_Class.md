...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Environment Light COMP](<./Environment_Light_COMP.md> "Environment Light COMP").   
