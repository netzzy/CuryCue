...
The Normal Map TOP takes an input image and creates a normal map by finding edges in the image. This can then be used for bump mapping (See [Phong MAT](<./Phong_MAT.md> "Phong MAT") and [PBR MAT](<./PBR_MAT.md> "PBR MAT")). 

See also [Normal Mapping](<./Normal_Mapping.md> "Normal Mapping"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[normalmapTOP_Class](<./NormalmapTOP_Class.md> "NormalmapTOP Class")
...
Extra Information for the Normal Map TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
