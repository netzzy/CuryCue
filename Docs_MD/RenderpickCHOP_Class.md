...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Render Pick CHOP](<./Render_Pick_CHOP.md> "Render Pick CHOP"). 

## Members`pickedSOP`→`OP`**(Read Only)** : 

> The [SOP](<./SOP_Class.md> "SOP Class") that was last picked.
