...
See [Channel Naming Patterns](<./Rename_CHOP.htm#Channel_Naming_Patterns> "Rename CHOP") for more ways to manipulate existing channel names into new ones. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[selectCHOP_Class](<./SelectCHOP_Class.md> "SelectCHOP Class")
...
The order of the names determine the order of the output channels. If a channel is specified multiple times, it is included in the output multiple times. __
...
Extra Information for the Select CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
