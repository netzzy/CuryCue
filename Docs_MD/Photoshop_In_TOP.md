...
[![RemoteConnections.png](./images/2/2f/RemoteConnections.png)](</File:RemoteConnections.png>). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[photoshopinTOP_Class](<./PhotoshopinTOP_Class.md> "PhotoshopinTOP Class")
...
Extra Information for the Photoshop In TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
