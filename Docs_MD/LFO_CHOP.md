...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lfoCHOP_Class](<./LfoCHOP_Class.md> "LfoCHOP Class")
...
* Triangle`tri`\- [![TouchChannels76.gif](./images/c/c0/TouchChannels76.gif)](</File:TouchChannels76.gif>)(-1 to 1) A ramp-up to 1 and ramp-down to -1 that can be shaped with the Bias parameter.
...
* Pulse`pulse`\- [![TouchChannels82.gif](./images/c/c4/TouchChannels82.gif)](</File:TouchChannels82.gif>)Produces a 1 for one sample, 0 otherwise.
...
Channel Name`channelname`\- A list of the names of the channels. You can put patterns like`chan[1-10]`to generate 10 channels. See [Pattern Expansion](<./Pattern_Expansion.md> "Pattern Expansion"). 

Each channel can be different by putting the channel index variable,`$C`in parameters like the frequency channel. __
...
Extra Information for the LFO CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
