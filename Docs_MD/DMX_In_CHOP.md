...
The DMX In CHOP receives channels from DMX, [Art-Net](<./Art-Net.md> "Art-Net"), [sACN](<./SACN.md> "SACN") or [KiNET](<https://www.colorkinetics.com/global/learn/optics-matter>) devices. Channel values for DMX are 0-255. Note that input rate is limited to the DMX maximum refresh rate of 44Hz. 
...
See also: [DMX Out POP](<./DMX_Out_POP.md> "DMX Out POP"), [Art-Net](<./Art-Net.md> "Art-Net"), [DMX Out CHOP](<./DMX_Out_CHOP.md> "DMX Out CHOP"), [DMX](<./DMX.md> "DMX")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[dmxinCHOP_Class](<./DmxinCHOP_Class.md> "DmxinCHOP Class")
...
Extra Information for the DMX In CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
