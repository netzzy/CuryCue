...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Dynamics CHOP](<./Audio_Dynamics_CHOP.md> "Audio Dynamics CHOP"). 
