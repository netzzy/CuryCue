...
See the [POP to DAT](<./POP_to_DAT.md> "POP to DAT") to find all the attributes of a POP. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[attributeconvertPOP_Class](</AttributeconvertPOP_Class> "AttributeconvertPOP Class")
...
Extra Information for the Attribute Convert POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
