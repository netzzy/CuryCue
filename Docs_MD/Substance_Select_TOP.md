...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[substanceselectTOP_Class](</SubstanceselectTOP_Class> "SubstanceselectTOP Class")
...
Extra Information for the Substance Select TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
