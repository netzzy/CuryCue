...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[outSOP_Class](<./OutSOP_Class.md> "OutSOP Class")
...
Extra Information for the Out SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
