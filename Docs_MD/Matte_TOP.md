...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[matteTOP_Class](<./MatteTOP_Class.md> "MatteTOP Class")
...
Extra Information for the Matte TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
