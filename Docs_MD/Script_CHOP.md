...
The Script CHOP enables numPy arrays to be converted into the CHOP's channels. Also any CHOP can get its channels converted into numPy arrays. (May 2021) See`numPyArray()`in [CHOP Class](<./CHOP_Class.md> "CHOP Class"). 

See also: [Script DAT](<./Script_DAT.md> "Script DAT"), [Script SOP](<./Script_SOP.md> "Script SOP"), [Script TOP](<./Script_TOP.md> "Script TOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[scriptCHOP_Class](<./ScriptCHOP_Class.md> "ScriptCHOP Class")
...
Extra Information for the Script CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
