...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:multiMix Ext](<./Palette-multiMix_Ext.md> "Palette:multiMix Ext")
...
Number Layers`Numberlayers`\- 

Input Filter Type`Inputfiltertype`\- ⊞ \- 
* Nearest Pixel`nearest`-
* Interpolate Pixels`linear`-
* Mipmap Pixels`mipmap`-


A / B Crossfade`Crossfade`\- 
...
Parameters - Layer 1 Page

Audio Source`Audiosource0`\- 

Layer 1 Source`Layersource0`\- 

Blend Mode`Blendmode0`\- ⊞ \- 
* Over`over`-
* Average`average`-
* Under`under`-
* Cross`cross`-
...
* Subtract`subtract`-
* Diff`difference`-
* Inv Diff`invDifference`-
* Exclude`exclusion`-


Crossfade Group`Crossfadeactive0`\- ⊞ \- 
* Off`-1`-
* A`0`-
* B`1`-


Link Audio`Linkaudio0`\- 
...
* Translate`Translate0x`-
* Translate`Translate0y`-
...
Swap Layer Source with`Swaplayersrc0`\- ⊞ \- 
* None`LayerNone`-
* Layer 1`layer0`-
* Layer 2`layer1`-


Swap Layer with`Swaplayer0`\- ⊞ \- 
* None`LayerNone`-
* Layer 1`layer0`-
* Layer 2`layer1`-
...
Parameters - Layer 2 Page

Audio Source`Audiosource1`\- 

Layer 2 Source`Layersource1`\- 

Blend Mode`Blendmode1`\- ⊞ \- 
* Over`over`-
* Average`average`-
* Under`under`-
* Cross`cross`-
...
Crossfade Group`Crossfadeactive1`\- ⊞ \- 
* Off`-1`-
* A`0`-
* B`1`-


Link Audio`Linkaudio1`\- 
...
* Translate`Translate1x`-
* Translate`Translate1y`-
...
Swap Layer Source with`Swaplayersrc1`\- ⊞ \- 
* None`LayerNone`-
* Layer 1`layer0`-
* Layer 2`layer1`-


Swap Layer with`Swaplayer1`\- ⊞ \- 
* None`LayerNone`-
* Layer 1`layer0`-
* Layer 2`layer1`-
...
Parameters - Layer 3 Page

Audio Source`Audiosource2`\- 

Layer 3 Source`Layersource2`\- 

Blend Mode`Blendmode2`\- ⊞ \- 
* Over`over`-
* Average`average`-
* Under`under`-
* Cross`cross`-
...
Crossfade Group`Crossfadeactive2`\- ⊞ \- 
* Off`-1`-
* A`0`-
* B`1`-


Link Audio`Linkaudio2`\- 
...
* Translate`Translate2x`-
* Translate`Translate2y`-
...
Swap Layer Source with`Swaplayersrc2`\- ⊞ \- 
* None`LayerNone`-
* Layer 1`layer0`-
* Layer 2`layer1`-
* Layer 3`layer2`-
...
Parameters - Layer 4 Page

Audio Source`Audiosource3`\- 

Layer 4 Source`Layersource3`\- 

Blend Mode`Blendmode3`\- ⊞ \- 
* Over`over`-
* Average`average`-
* Under`under`-
* Cross`cross`-
...
Crossfade Group`Crossfadeactive3`\- ⊞ \- 
* Off`-1`-
* A`0`-
* B`1`-


Link Audio`Linkaudio3`\- 
...
* Translate`Translate3x`-
* Translate`Translate3y`-
...
Swap Layer Source with`Swaplayersrc3`\- ⊞ \- 
* None`LayerNone`-
* Layer 1`layer0`-
* Layer 2`layer1`-
* Layer 3`layer2`-
