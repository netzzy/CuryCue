...
See [Write a CPlusPlus Plugin](<./Write_a_CPlusPlus_Plugin.md> "Write a CPlusPlus Plugin") and the other articles in the [C++ category](<./Category-C++.md> "Category:C++") for more detailed information on how to make .dll for use with this SOP. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cplusplusSOP_Class](<./CplusplusSOP_Class.md> "CplusplusSOP Class")
...
Extra Information for the CPlusPlus SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
