...
The OAK Select can receive images of many different formats from the OAK Camera. These formats include RGB, monochrome, depth images, and XYZ [Point Clouds](</Point_Clouds> "Point Clouds"). 

See Also: [OAK-D](<./OAK-D.md> "OAK-D") [OAK Device CHOP](<./OAK_Device_CHOP.md> "OAK Device CHOP") [OAK Select CHOP](<./OAK_Select_CHOP.md> "OAK Select CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[oakselectTOP_Class](<./OakselectTOP_Class.md> "OakselectTOP Class")
...
Cache Size`cachesize`\- The Cache Size parameter works like the Queue Size parameter on the [OAK Select CHOP](<./OAK_Select_CHOP.md> "OAK Select CHOP"). Picking 2 is a good default choice because it enables TouchDesigner to show an image to the user while asynchronously writing new data into the remaining buffer. 
...
Extra Information for the oakselect TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
