...
CHOPs like the [Lag CHOP](<./Lag_CHOP.md> "Lag CHOP") and [Filter CHOP](<./Filter_CHOP.md> "Filter CHOP") look back in time (iterate) internal to the CHOP, but sometimes the output of a chain of CHOPs is needed as the input of the same chain one frame later. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[feedbackCHOP_Class](<./FeedbackCHOP_Class.md> "FeedbackCHOP Class")
...
Extra Information for the Feedback CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
