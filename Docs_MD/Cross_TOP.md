...
The Cross TOP blends between the two input images based on the value of the Cross parameter (refered to as _Cross_value_ below).`Output = Input1*(1-_Cross_value_) + Input2*(_Cross_value_)`**Note:** This TOP supports 3D Textures and 2D Texture Arrays. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[crossTOP_Class](<./CrossTOP_Class.md> "CrossTOP Class")
...
Extra Information for the Cross TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
