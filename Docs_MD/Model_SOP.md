...
Any SOP can be [locked](<./Lock_Flag.md> "Lock Flag") and modified with the modeler. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[modelSOP_Class](<./ModelSOP_Class.md> "ModelSOP Class")

## 

Info CHOP Channels

Extra Information for the Model SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
