...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[choptoDAT_Class](<./ChoptoDAT_Class.md> "ChoptoDAT Class")
...
Extra Information for the CHOP to DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
