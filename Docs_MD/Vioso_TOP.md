...
The Vioso TOP lets you load calibration data retrieved from running the [VIOSO 6](<https://vioso.com/software/vioso6/>) software. Please refer to the [Vioso](<./Vioso.md> "Vioso") entry for a complete guide on TouchDesigners integration of the VIOSO 6. 

Also have a look at the [MPCDI TOP](<./MPCDI_TOP.md> "MPCDI TOP") for loading mpcdi files exported from VIOSO. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[viosoTOP_Class](<./ViosoTOP_Class.md> "ViosoTOP Class")

## 

Parameters - Setup Page

Configuration File`configfile`\- Specify the location of the .vwf file exported from Vioso 6. 

Projector Index`projectorindex`\- Specify the index of the output projector. 
...
Extra Information for the Vioso TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
