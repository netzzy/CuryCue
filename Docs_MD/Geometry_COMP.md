...
The Geometry Component is a 3D surface or [3D Object](<./Object.md> "Object") that you render in TouchDesigner with a [Render TOP](<./Render_TOP.md> "Render TOP"). [Lights](<./Light_COMP.md> "Light COMP"), [Cameras](<./Camera_COMP.md> "Camera COMP") and other Components affect the scene, but are not visible surfaces. 

Each Geometry Component contains a [Network](<./Network.md> "Network") containing [SOPs](<./SOP.md> "SOP") (and any other node types), where SOPs are the operators that define its 3D shape. The 3D surfaces can be [polygons](<./Polygon.md> "Polygon"), [particles](<./Particle.md> "Particle"), sprites, [meshes](<./Mesh.md> "Mesh"), [NURBS](<./Spline.md> "Spline") (with trim curves), [Bezier](<./Spline.md> "Spline") patches or [metaballs](<./Metaball.md> "Metaball"). They can be shaded as solid-shaded surfaces or as wireframes. 

In the Geometry COMP's network 
* the [SOPs](<./SOP.md> "SOP") (Surface Operators) whose [Render Flag](<./Render_Flag.md> "Render Flag") is On are rendered by a [Render TOP](<./Render_TOP.md> "Render TOP"). More than one SOP can be turned on for rendering in a Geometry component.
  * The SOPs whose [Display Flag](<./Display_Flag.md> "Display Flag") is on are seen in the [Geometry Viewer](<./Geometry_Viewer.md> "Geometry Viewer") of the Geometry COMP and Camera COMPs in the same network.


NOTE: Most often users turn on/off the Render and Display flags together so they are always in the same state. 

See [Geometry Viewer](<./Geometry_Viewer.md> "Geometry Viewer") to learn about how you can inspect the SOPs that are turned on for display. 

Some SOPs, like the [Texture SOP](<./Texture_SOP.md> "Texture SOP") determine how texture images wrap and fit on the surface. 

Every Geometry component needs a [Material](<./MAT.md> "MAT") (MAT) operator to apply to the surface. This is assigned in the Material parameter of the Geometry component, or with a [Material SOP](<./Material_SOP.md> "Material SOP"). 
...
See [Geometry Viewer](<./Geometry_Viewer.md> "Geometry Viewer"), [Render Flag](<./Render_Flag.md> "Render Flag") and [Display Flag](<./Display_Flag.md> "Display Flag"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[geometryCOMP_Class](<./GeometryCOMP_Class.md> "GeometryCOMP Class")
...
Extra Information for the Geometry COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
