...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[projectionPOP_Class](</ProjectionPOP_Class> "ProjectionPOP Class")
...
Extra Information for the Projection POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
