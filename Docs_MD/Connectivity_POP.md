...
The Connectivity POP is intended to re-connect the input's points with a set of new primitives, similar to what the [Grid POP](<./Grid_POP.md> "Grid POP") or [Torus POP](<./Torus_POP.md> "Torus POP") does to their sets of points. It works on any POP, especially those that ore organized as multi-[Dimensions](<./Dimension.md> "Dimension"), that is, having rows, columns, slices and any number of dimensions. 
...
See also [Torus POP](<./Torus_POP.md> "Torus POP"), [Dimension POP](<./Dimension_POP.md> "Dimension POP"), [Dimension](<./Dimension.md> "Dimension"), [Grid POP](<./Grid_POP.md> "Grid POP"), [Plane POP](<./Plane_POP.md> "Plane POP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[connectivityPOP_Class](<./ConnectivityPOP_Class.md> "ConnectivityPOP Class")
...
Extra Information for the Connectivity POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
