...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio VST CHOP](<./Audio_VST_CHOP.md> "Audio VST CHOP"). 
...
> Sends a volume off event for each channel and note off event for each note.`send(*messages, timestamp=0)`→`None`: 
...
>     
[/code]`sendExclusive(*messages, timestamp=0)`→`None`: 
...
TouchDesigner Build: Latest\nwikieditorwikieditorwikieditorwikieditorwikieditor2022.24140before 2022.24140
