...
The Audio Devices DAT provides information about all detected audio devices including driver, direction (input or output), label, and name that can be referenced in the [Audio Device In CHOP](<./Audio_Device_In_CHOP.md> "Audio Device In CHOP") and [Audio Device Out CHOP](<./Audio_Device_Out_CHOP.md> "Audio Device Out CHOP"). 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[audiodevicesDAT_Class](<./AudiodevicesDAT_Class.md> "AudiodevicesDAT Class")
...
Extra Information for the Audio Devices DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
