...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[glslPOP_Class](</GlslPOP_Class> "GlslPOP Class")
...
Extra Information for the GLSL POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
