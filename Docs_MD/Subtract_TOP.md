...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[subtractTOP_Class](<./SubtractTOP_Class.md> "SubtractTOP Class")
...
Extra Information for the Subtract TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
