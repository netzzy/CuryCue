...
The popDialog custom Component builds on [Container COMP](<./Container_COMP.md> "Container COMP") to make an easy-to-use pop-up dialog for basic notifications and queries. The dialog can be set up using parameters or script. 
...
For examples of how to set up a popDialog, see **[PopDialog Custom COMP Examples](<./PopDialog_Custom_COMP_Examples.md> "PopDialog Custom COMP Examples")**. 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:popDialog Ext](<./Palette-popDialog_Ext.md> "Palette:popDialog Ext")
