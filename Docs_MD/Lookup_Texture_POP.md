...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lookuptexturePOP_Class](</LookuptexturePOP_Class> "LookuptexturePOP Class")
...
Extra Information for the Lookup Texture POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
