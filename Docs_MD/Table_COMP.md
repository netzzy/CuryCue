...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[tableCOMP_Class](</TableCOMP_Class> "TableCOMP Class")
...
Info Format`infoformat`\- ⊞ \- Determines how the state information in a connected [Info DAT](<./Info_DAT.md> "Info DAT") is displayed. 
...
Operator Inputs
* Input 0:  \- Default input which should be a [Table DAT](<./Table_DAT.md> "Table DAT") with each row being the content of the Table COMPs cells.

## 

Info CHOP Channels

Extra Information for the Table COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
