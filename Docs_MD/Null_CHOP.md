...
It is often used to [Export](<./Export.md> "Export") channels to parameters, which allows you to experiment with the CHOPs that feed into the Null without having to un-export from one CHOP and re-export from another. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nullCHOP_Class](<./NullCHOP_Class.md> "NullCHOP Class")

## 

Parameters - Null Page

Cook Type`cooktype`\- ⊞ \- This controls how nodes downstream from the Null CHOP are triggered for recooking when the Null CHOP output changes. See also: [Cook](<./Cook.md> "Cook")
...
Please note that downstream cooks may also cook for a variety of reasons including viewing the contents of the data while editing nodes, etc. __
...
Extra Information for the Null CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
