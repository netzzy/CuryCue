...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [SocketIO DAT](<./SocketIO_DAT.md> "SocketIO DAT").   
  
## Members

No operator specific members. 

## Methods`emit(event, data=None)`→`None`: 
