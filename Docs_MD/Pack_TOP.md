...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[packTOP_Class](<./PackTOP_Class.md> "PackTOP Class")
...
Extra Information for the Pack TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
