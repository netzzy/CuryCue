...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [LTC Out CHOP](<./LTC_Out_CHOP.md> "LTC Out CHOP"). 

## Members`timecode`→`tdu.Timecode`**(Read Only)** : 

> Get a Timecode object for the timecode data representation of the LTC Out CHOP. See [Timecode Class](<./Timecode_Class.md> "Timecode Class").
