...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[importselectPOP_Class](</ImportselectPOP_Class> "ImportselectPOP Class")
...
Extra Information for the Import Select POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
