...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [Web Client DAT](<./Web_Client_DAT.md> "Web Client DAT").   
  
## Members`connections`→`list`**(Read Only)** : 

> Get a list of active connection identifiers.

## Methods`request(url, method, header=None, data=None, pars=None, authType=None, username=None, password=None, appKey=None, appSecret=None, oauth1Token=None, oauth1Secret=None, oauth2Token=None, uploadFile=None, timeout=60000)`→`int`: 
