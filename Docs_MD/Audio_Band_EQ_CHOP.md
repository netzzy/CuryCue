...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[audiobandeqCHOP_Class](<./AudiobandeqCHOP_Class.md> "AudiobandeqCHOP Class")
...
Extra Information for the Audio Band EQ CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
