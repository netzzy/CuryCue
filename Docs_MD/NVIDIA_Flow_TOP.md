...
The Nvidia Flow TOP calculates the Flow simulation and renders it. It requires a [Nvidia Flow Emitter COMP](<./Nvidia_Flow_Emitter_COMP.md> "Nvidia Flow Emitter COMP") to emit gas into the Flow simulation. 

See also [Nvidia Flow Emitter COMP](<./Nvidia_Flow_Emitter_COMP.md> "Nvidia Flow Emitter COMP"), [Nvidia Flow](<./Nvidia_Flow.md> "Nvidia Flow"). 

Read more here [Nvidia Flow Artist Tools](<https://docs.nvidia.com/gameworks/content/artisttools/Flow/index.html>)

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[flowTOP_Class](<./FlowTOP_Class.md> "FlowTOP Class")
...
Camera`camera`\- Specify the [Camera COMP](<./Camera_COMP.md> "Camera COMP") to view the simulation from. Note: Must be camera with Projection = Perspective. 

Flow Emitters`emitters`\- Specify the [Nvidia Flow Emitter COMPs](<./Nvidia_Flow_Emitter_COMP.md> "Nvidia Flow Emitter COMP") to include in the simulation. 
...
Enable`enableshadow`\- Enables Volume shadow rendering for the simulation. Shadowing generates light intensity values that overwrite the "burn" channel of the grid. Values range from 0 to 1, where 0 is fully shadowed. Shadow visibilty can be controlled by enabling 'Override Emitter Intensity Mask' or by adjusting the 'Burn Intensity Mask', 'Burn Alpha Mask', and 'Burn Color Mask' in [Nvidia Flow Emitter COMP](<./Nvidia_Flow_Emitter_COMP.md> "Nvidia Flow Emitter COMP")
...
Extra Information for the Nvidia Flow TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
