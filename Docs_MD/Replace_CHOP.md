...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[replaceCHOP_Class](</ReplaceCHOP_Class> "ReplaceCHOP Class")
...
Extra Information for the Replace CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
