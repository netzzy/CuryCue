...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[bonegroupSOP_Class](<./BonegroupSOP_Class.md> "BonegroupSOP Class")
...
Extra Information for the Bone Group SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
