...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[poptoSOP_Class](</PoptoSOP_Class> "PoptoSOP Class")
...
Extra Information for the POP to SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
