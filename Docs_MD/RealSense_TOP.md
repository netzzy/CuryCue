...
[RealSense](<./RealSense.md> "RealSense") is a tracking device from Intel. The RealSense TOP connects to Intel [RealSense](<./RealSense.md> "RealSense") devices and outputs color, depth and IR data from it. 

See also [RealSense](<./RealSense.md> "RealSense") for hardware information and installation instruction, and the [RealSense CHOP](<./RealSense_CHOP.md> "RealSense CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[realsenseTOP_Class](<./RealsenseTOP_Class.md> "RealsenseTOP Class")
...
Skeleton Tracking`skeltracking`\- When enabled, performs skeleton tracking using the [Cubemos Skeleton Tracking API](<https://www.intelrealsense.com/skeleton-tracking/>). The results can be fetched via the [RealSense CHOP](<./RealSense_CHOP.md> "RealSense CHOP"). A Cubemos license is required for usage. A trial license is available. 
...
Extra Information for the RealSense TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
