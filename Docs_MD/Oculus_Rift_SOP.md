...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[oculusriftSOP_Class](</OculusriftSOP_Class> "OculusriftSOP Class")
...
Extra Information for the Oculus Rift SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
