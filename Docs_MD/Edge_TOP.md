...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[edgeTOP_Class](<./EdgeTOP_Class.md> "EdgeTOP Class")
...
Extra Information for the Edge TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
