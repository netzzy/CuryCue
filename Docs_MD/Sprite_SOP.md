...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[spriteSOP_Class](</SpriteSOP_Class> "SpriteSOP Class")
...
Camera`camera`\- The geometry will always face the [Camera COMP](<./Camera_COMP.md> "Camera COMP") specified here. 
...
**NOTE** : Inbetween Falloff Start and Falloff End the width is determined using a half-cosine falloff between the two values. __

## 

Info CHOP Channels

Extra Information for the Sprite SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
