...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cplusplusCHOP_Class](<./CplusplusCHOP_Class.md> "CplusplusCHOP Class")
...
Extra Information for the CPlusPlus CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
