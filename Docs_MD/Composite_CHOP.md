...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[compositeCHOP_Class](<./CompositeCHOP_Class.md> "CompositeCHOP Class")
...
Extra Information for the Composite CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
