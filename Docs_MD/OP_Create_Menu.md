...
The OP Create Dialog, also called the Tab menu, lets you create new [Operators](<./Operator.md> "Operator") and is accessed by: 
* double-clicking on the background of a network
  * pressing the Tab key
  * clicking the + icon at the top of a Network Editor Pane beside the path
  * use [MMB](</index.php?title=MMB&action=edit&redlink=1> "MMB \(page does not exist\)") and/or [RMB](</index.php?title=RMB&action=edit&redlink=1> "RMB \(page does not exist\)") on OP inputs/outputs
  * [RMB](</index.php?title=RMB&action=edit&redlink=1> "RMB \(page does not exist\)") -> Add Operator on a [Wire](<./Wire.md> "Wire")
  * [RMB](</index.php?title=RMB&action=edit&redlink=1> "RMB \(page does not exist\)") -> Add Operator on an empty part of a network
...
Select the [Operator Family](<./Operator.md> "Operator") from the headings COMP TOP CHOP SOP MAT DAT. 
...
See Also [Change OP Type Dialog](<./Change_OP_Type_Dialog.md> "Change OP Type Dialog")
