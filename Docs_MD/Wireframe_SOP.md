...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[wireframeSOP_Class](</WireframeSOP_Class> "WireframeSOP Class")
...
Extra Information for the Wireframe SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
