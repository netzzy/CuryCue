...
See also [PBR MAT](<./PBR_MAT.md> "PBR MAT"), [Phong MAT](<./Phong_MAT.md> "Phong MAT"), [Normalize POP](<./Normalize_POP.md> "Normalize POP") and the [Projection POP](<./Projection_POP.md> "Projection POP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[texturemapPOP_Class](<./TexturemapPOP_Class.md> "TexturemapPOP Class")
...
Extra Information for the Texture Map POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
