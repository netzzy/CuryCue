...
It can receive [Hap Q](<./Hap.md> "Hap"), Hap Q Alpha, and Uncompressed video. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[touchinTOP_Class](<./TouchinTOP_Class.md> "TouchinTOP Class")
...
Extra Information for the Touch In TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
