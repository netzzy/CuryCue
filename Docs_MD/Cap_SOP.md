...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[capSOP_Class](<./CapSOP_Class.md> "CapSOP Class")
...
Extra Information for the Cap SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
