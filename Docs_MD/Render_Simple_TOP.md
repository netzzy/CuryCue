...
Render Simple does not require a [Camera COMP](<./Camera_COMP.md> "Camera COMP"), [Geometry COMP](<./Geometry_COMP.md> "Geometry COMP") or [Light COMP](<./Light_COMP.md> "Light COMP") that is required by the more full-featured [Render TOP](<./Render_TOP.md> "Render TOP"). 

See also [Render TOP](<./Render_TOP.md> "Render TOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[rendersimpleTOP_Class](<./RendersimpleTOP_Class.md> "RendersimpleTOP Class")
...
Extra Information for the Render Simple TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
