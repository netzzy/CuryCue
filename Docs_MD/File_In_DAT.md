...
See also [Table DAT](<./Table_DAT.md> "Table DAT"), [Text DAT](<./Text_DAT.md> "Text DAT"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fileinDAT_Class](<./FileinDAT_Class.md> "FileinDAT Class")
...
Extra Information for the File In DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
