...
Retrieves the audio from a [NDI In TOP](<./NDI_In_TOP.md> "NDI In TOP")'s NDI stream. The audio signal can then be modified or output via CHOPs. See [NDI](<./NDI.md> "NDI"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[audiondiCHOP_Class](<./AudiondiCHOP_Class.md> "AudiondiCHOP Class")
...
NDI In TOP`ndiintop`\- Specify which [NDI In TOP](<./NDI_In_TOP.md> "NDI In TOP")'s NDI stream to get the audio from. 
