...
The BlackTrax CHOP will accept tracking data from [BlackTrax Motion Tracking Systems](<http://blacktrax.cast-soft.com/>). See [BlackTrax](<./BlackTrax.md> "BlackTrax"). 
...
See also [BlackTrax](<./BlackTrax.md> "BlackTrax"), [PosiStageNet CHOP](<./PosiStageNet_CHOP.md> "PosiStageNet CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[blacktraxCHOP_Class](<./BlacktraxCHOP_Class.md> "BlacktraxCHOP Class")
...
Extra Information for the BlackTrax CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
