...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lookupchannelPOP_Class](</LookupchannelPOP_Class> "LookupchannelPOP Class")
...
Extra Information for the Lookup Channel POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
