...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[serialdevicesDAT_Class](<./SerialdevicesDAT_Class.md> "SerialdevicesDAT Class")

## 

Parameters - Serial Devices Page

Callbacks DAT`callbacks`\- Runs this script once for each change to the table. See [serialdevicesDAT_Class](<./SerialdevicesDAT_Class.md> "SerialdevicesDAT Class") for usage. 
