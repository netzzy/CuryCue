...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[wireframeMAT_Class](</WireframeMAT_Class> "WireframeMAT Class")
...
Extra Information for the Wireframe MAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
