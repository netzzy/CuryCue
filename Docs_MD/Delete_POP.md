...
For pattern matching on the Pattern page, see [Pattern Matching](<./Pattern_Matching.md> "Pattern Matching"). 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[deletePOP_Class](<./DeletePOP_Class.md> "DeletePOP Class")
...
Extra Information for the Delete POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
