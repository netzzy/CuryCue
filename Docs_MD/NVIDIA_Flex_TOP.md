...
The Nvidia Flex TOP can grab the Nvidia Flex simulation data of an [Actor COMP](<./Actor_COMP.md> "Actor COMP"). The Actor COMP must be in a valid [Nvidia Flex](<./Flex.md> "Flex") simulation (ie. controlled by an [Nvidia Flex Solver COMP](<./Nvidia_Flex_Solver_COMP.md> "Nvidia Flex Solver COMP")). 
...
See also: [Flex](<./Flex.md> "Flex"), [Nvidia Flex Solver COMP](<./Nvidia_Flex_Solver_COMP.md> "Nvidia Flex Solver COMP"), [Actor COMP](<./Actor_COMP.md> "Actor COMP"), [Force COMP](<./Force_COMP.md> "Force COMP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[flexTOP_Class](<./FlexTOP_Class.md> "FlexTOP Class")
...
Extra Information for the Nvidia Flex TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
