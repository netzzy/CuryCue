...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[remapTOP_Class](<./RemapTOP_Class.md> "RemapTOP Class")
...
Extra Information for the Remap TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
