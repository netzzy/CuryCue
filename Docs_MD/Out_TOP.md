...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[outTOP_Class](<./OutTOP_Class.md> "OutTOP Class")
...
Extra Information for the Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
