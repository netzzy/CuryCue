...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[transformxyzCHOP_Class](</TransformxyzCHOP_Class> "TransformxyzCHOP Class")
...
Extra Information for the Transform XYZ CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
