...
The Bullet Solver CHOP is used in conjunction with a [Bullet Dynamics](<./Bullet_Dynamics.md> "Bullet Dynamics") system. It outputs the solved results from a Bullet simulation and can include the results for the entire system ([Bullet Solver COMP](<./Bullet_Solver_COMP.md> "Bullet Solver COMP")) or an individual actor ([Actor COMP](<./Actor_COMP.md> "Actor COMP")) within a system. 
...
Extra Information for the Bullet Solver CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
