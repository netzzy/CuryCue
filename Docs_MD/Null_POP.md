...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[nullPOP_Class](</NullPOP_Class> "NullPOP Class")
...
Extra Information for the Null POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
