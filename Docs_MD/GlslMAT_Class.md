...
This class inherits from the [ MAT class](<./MAT_Class.md> "MAT Class"). It references a specific [GLSL MAT](<./GLSL_MAT.md> "GLSL MAT"). 

## Members`compileResult`→`str`**(Read Only)** : 
