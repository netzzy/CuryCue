...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[pointfileselectTOP_Class](</PointfileselectTOP_Class> "PointfileselectTOP Class")
...
Extra Information for the Point File Select TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
