...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[rectangleTOP_Class](<./RectangleTOP_Class.md> "RectangleTOP Class")
...
Extra Information for the Rectangle TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
