...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inDAT_Class](<./InDAT_Class.md> "InDAT Class")
...
Extra Information for the In DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
