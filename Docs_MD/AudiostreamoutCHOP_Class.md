...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Stream Out CHOP](<./Audio_Stream_Out_CHOP.md> "Audio Stream Out CHOP"). 
