...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[fanCHOP_Class](<./FanCHOP_Class.md> "FanCHOP Class")
...
Extra Information for the Fan CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
