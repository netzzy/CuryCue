...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[resolutionTOP_Class](<./ResolutionTOP_Class.md> "ResolutionTOP Class")
...
Extra Information for the Resolution TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
