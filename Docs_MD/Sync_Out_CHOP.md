...
An [Info DAT](<./Info_DAT.md> "Info DAT"), pointing to the Sync Out CHOP, provides a detailed list of all clients: 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[syncoutCHOP_Class](<./SyncoutCHOP_Class.md> "SyncoutCHOP Class")
