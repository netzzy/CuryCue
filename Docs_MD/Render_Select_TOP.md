...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[renderselectTOP_Class](<./RenderselectTOP_Class.md> "RenderselectTOP Class")
...
Extra Information for the Render Select TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
