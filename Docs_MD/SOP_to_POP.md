...
Mesh primitives in SOPs are converted to a choice of quad, line strip or point primitives. It does not preserve the row/column [Dimension](<./Dimension.md> "Dimension") but the [Dimension POP](<./Dimension_POP.md> "Dimension POP") can be used to preserve that information. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[soptoPOP_Class](</SoptoPOP_Class> "SoptoPOP Class")
...
Extra Information for the SOP to POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
