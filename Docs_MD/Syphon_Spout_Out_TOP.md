...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[syphonspoutoutTOP_Class](<./SyphonspoutoutTOP_Class.md> "SyphonspoutoutTOP Class")
...
Extra Information for the Syphon Spout Out TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
