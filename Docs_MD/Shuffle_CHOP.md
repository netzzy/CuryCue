...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[shuffleCHOP_Class](</ShuffleCHOP_Class> "ShuffleCHOP Class")
...
Extra Information for the Shuffle CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
