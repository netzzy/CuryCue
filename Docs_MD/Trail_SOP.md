...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[trailSOP_Class](</TrailSOP_Class> "TrailSOP Class")
...
Extra Information for the Trail SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
