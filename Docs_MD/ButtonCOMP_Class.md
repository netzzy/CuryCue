...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Button COMP](<./Button_COMP.md> "Button COMP"). 

## Members

No operator specific members. 

## Methods`click(val, clickCount=1, force=False, left=False, middle=False, right=False)`→`None`: 
