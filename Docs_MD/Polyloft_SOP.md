...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[polyloftSOP_Class](<./PolyloftSOP_Class.md> "PolyloftSOP Class")
...
Extra Information for the Polyloft SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
