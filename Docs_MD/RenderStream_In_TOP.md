...
This node brings in image data sent over the [RenderStream](<./RenderStream.md> "RenderStream") protocol from [Disguise](<https://www.disguise.one/en/products/renderstream/>). The actual setup and sync of the RenderStream connection is done with the [RenderStream In CHOP](<./RenderStream_In_CHOP.md> "RenderStream In CHOP"). 

See also [RenderStream In CHOP](<./RenderStream_In_CHOP.md> "RenderStream In CHOP"), [RenderStream Out TOP](<./RenderStream_Out_TOP.md> "RenderStream Out TOP"), [RenderStream](<./RenderStream.md> "RenderStream"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[renderstreaminTOP_Class](</RenderstreaminTOP_Class> "RenderstreaminTOP Class")
...
Extra Information for the RenderStream In TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
