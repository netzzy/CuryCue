...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Spectrum CHOP](<./Audio_Spectrum_CHOP.md> "Audio Spectrum CHOP"). 
