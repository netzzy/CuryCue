...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[switchCHOP_Class](<./SwitchCHOP_Class.md> "SwitchCHOP Class")
...
Extra Information for the Switch CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
