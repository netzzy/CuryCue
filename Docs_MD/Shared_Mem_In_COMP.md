...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sharedmeminCOMP_Class](</SharedmeminCOMP_Class> "SharedmeminCOMP Class")
...
Extra Information for the Shared Mem In COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
