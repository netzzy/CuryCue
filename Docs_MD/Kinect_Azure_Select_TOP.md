...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[kinectazureselectTOP_Class](</KinectazureselectTOP_Class> "KinectazureselectTOP Class")
...
Extra Information for the Kinect Azure Select TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
