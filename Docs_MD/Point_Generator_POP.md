...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[pointgeneratorPOP_Class](</PointgeneratorPOP_Class> "PointgeneratorPOP Class")
...
Extra Information for the Point Generator POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
