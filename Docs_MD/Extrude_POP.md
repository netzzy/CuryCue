...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[extrudePOP_Class](</ExtrudePOP_Class> "ExtrudePOP Class")
...
Extra Information for the Extrude POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
