...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sequencerCHOP_Class](</SequencerCHOP_Class> "SequencerCHOP Class")
...
Extra Information for the Sequencer CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
