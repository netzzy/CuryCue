...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [Audio Web Render CHOP](<./Audio_Web_Render_CHOP.md> "Audio Web Render CHOP"). 
