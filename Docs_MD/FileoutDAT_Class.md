...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [File Out DAT](<./File_Out_DAT.md> "File Out DAT"). 

## Members`writeCount`→`int`**(Read Only)** : 
