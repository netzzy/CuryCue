...
See also [Kinect TOP](<./Kinect_TOP.md> "Kinect TOP"), [Kinect](<./Kinect.md> "Kinect") and [Kinect1](<./Kinect1.md> "Kinect1"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[kinectCHOP_Class](<./KinectCHOP_Class.md> "KinectCHOP Class")
...
**NOTE:** Interaction mode requires a depth resolution of 640x480. As such, a [Kinect TOP](<./Kinect_TOP.md> "Kinect TOP") displaying a depth image for the same sensor will output an image with a resolution of 640x480 and the Near Depth Mode setting will be set in the Kinect CHOP. 

For guidelines in creating applications with Kinect Interaction, download the [Kinect for Windows Human Interface Guidelines](<http://download.microsoft.com/download/B/0/7/B070724E-52B4-4B1A-BD1B-05CC28D07899/Human_Interface_Guidelines_v1.7.0.pdf>). __
...
Extra Information for the Kinect CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
