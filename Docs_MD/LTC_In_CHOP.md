...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[ltcinCHOP_Class](<./LtcinCHOP_Class.md> "LtcinCHOP Class")
...
Extra Information for the LTC In CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
