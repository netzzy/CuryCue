...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lookupattributePOP_Class](</LookupattributePOP_Class> "LookupattributePOP Class")
...
Extra Information for the Lookup Attribute POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
