...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[multiplyTOP_Class](<./MultiplyTOP_Class.md> "MultiplyTOP Class")
...
Extra Information for the Multiply TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
