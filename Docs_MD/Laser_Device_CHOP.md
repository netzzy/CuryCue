...
See [Lasers](<./Lasers.md> "Lasers") for an overview of lasers with TouchDesigner. 
...
An issue you may run into is IP discovery for the EtherDream for which you can use the [EtherDream DAT](<./EtherDream_DAT.md> "EtherDream DAT"). 

Helios/ShowNET both have auto-populating menus for attached devices. 

See also: [Laser CHOP](<./Laser_CHOP.md> "Laser CHOP"), [EtherDream DAT](<./EtherDream_DAT.md> "EtherDream DAT"), [Pattern CHOP](<./Pattern_CHOP.md> "Pattern CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[laserdeviceCHOP_Class](<./LaserdeviceCHOP_Class.md> "LaserdeviceCHOP Class")
...
Network Address`netaddress`\- The network address of the EtherDream device to send the packets to. EtherDream IP can be found be polling devices on the network using the [EtherDream DAT](<./EtherDream_DAT.md> "EtherDream DAT"). 
...
Extra Information for the Laser Device CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
