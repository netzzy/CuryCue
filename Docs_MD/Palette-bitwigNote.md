...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[Palette:bitwigNote1 Ext](</index.php?title=Palette:bitwigNote1_Ext&action=edit&redlink=1> "Palette:bitwigNote1 Ext \(page does not exist\)")

## 

Parameters - Bitwig Midi Note Page
