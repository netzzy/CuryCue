...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[extendCHOP_Class](<./ExtendCHOP_Class.md> "ExtendCHOP Class")
...
Extra Information for the Extend CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
