...
The channels used by the FreeD Out CHOP are: 
    ...
    _tx, ty, tz_ \- camera position, can be connected to the [Camera COMP](<./Camera_COMP.md> "Camera COMP") Translate parameters. Values can range from +/- 131.07m.
    _rx, ry, rz_ \- camera rotation, can be connected to the [Camera COMP](<./Camera_COMP.md> "Camera COMP") Rotate parameters. Values can range from +/- 256 degrees.
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[freedoutCHOP_Class](</FreedoutCHOP_Class> "FreedoutCHOP Class")
