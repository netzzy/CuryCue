...
If you want to use Quadro Sync/Hardware Frame Lock, use the [QSync Utility](<https://www.nvidia.com/en-us/drivers/qsync-utility/>) to configure that now. Quadro Sync [Hardware Frame Lock](<./Hardware_Frame_Lock.md> "Hardware Frame Lock") is supported in Pro versions, allowing multiple GPUs to output in sync across multiple TouchDesigner instances. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[directdisplayoutTOP_Class](<./DirectdisplayoutTOP_Class.md> "DirectdisplayoutTOP Class")
...
Hardware Frame-Lock`hwframelock`\- Enables [Hardware Frame Lock](<./Hardware_Frame_Lock.md> "Hardware Frame Lock"). Only available with Pro licenses. 
