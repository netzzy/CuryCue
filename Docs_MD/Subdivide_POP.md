...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[subdividePOP_Class](</SubdividePOP_Class> "SubdividePOP Class")
...
Extra Information for the Subdivide POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
