...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[transformTOP_Class](<./TransformTOP_Class.md> "TransformTOP Class")
...
Extra Information for the Transform TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
