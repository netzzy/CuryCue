...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[revolvePOP_Class](<./RevolvePOP_Class.md> "RevolvePOP Class")
...
Extra Information for the Revolve POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
