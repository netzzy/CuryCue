...
See [POP Dimension](</POP_Dimension> "POP Dimension"). - Dimension is a property of all POPs that you can see in the popup info for a POP. It defines a virtual arrangement of the points, most simply as rows and columns of points (that would be two dimensions) (It doesn't matter how they are connected). In this case the total number of points = numberOfRows * numberOfColumns. 
...
See also [Extrude POP](<./Extrude_POP.md> "Extrude POP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[skinPOP_Class](</SkinPOP_Class> "SkinPOP Class")
...
Extra Information for the Skin POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
