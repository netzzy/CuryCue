...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[opviewerCOMP_Class](<./OpviewerCOMP_Class.md> "OpviewerCOMP Class")
...
Draw TOP Directly`topdirect`\- When this is On for TOPs, you always see the RGBA image, as if this was simply a [Select TOP](<./Select_TOP.md> "Select TOP"). Normally you see what the viewer is currently displaying, which for TOPs may have overlays and not be displaying RGB. 
...
Extra Information for the OP Viewer COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
