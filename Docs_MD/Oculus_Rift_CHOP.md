...
The Oculus Rift CHOP connects to an [Oculus Rift](<./Oculus_Rift.md> "Oculus Rift") device and outputs several useful sets of channels that can be used to integrate the Oculus Rift into projects. 
...
The devices calibration parameters are another option. These can be used to generate the projection matrices and distortion shaders, although both of these are already available (see below and [Oculus Rift TOP](<./Oculus_Rift_TOP.md> "Oculus Rift TOP")). This data is constant, but may differ on future devices. 
...
See also [Oculus Rift](<./Oculus_Rift.md> "Oculus Rift")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[oculusriftCHOP_Class](<./OculusriftCHOP_Class.md> "OculusriftCHOP Class")
...
Extra Information for the Oculus Rift CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
