...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[switchPOP_Class](</SwitchPOP_Class> "SwitchPOP Class")
...
Extra Information for the Switch POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
