...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Parameter COMP](<./Parameter_COMP.md> "Parameter COMP"). 

## Members`minWidth`→`int`**(Read Only)** : 
