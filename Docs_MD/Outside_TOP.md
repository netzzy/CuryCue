...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[outsideTOP_Class](<./OutsideTOP_Class.md> "OutsideTOP Class")
...
Extra Information for the Outside TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
