...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[isosurfaceSOP_Class](<./IsosurfaceSOP_Class.md> "IsosurfaceSOP Class")
...
Example 1:`(me.curPos.x**2) / (4*4) - (me.curPos.y**2) / (3*3) + me.curPos.z`This formula creates a hyperbolic paraboloid, or saddle shape. 

Example 2:`(me.curPos.x**2) / 0.1 + (me.curPos.y**2) / 2 + (me.curPos.z**2) / 6 - 1`This formula creates an ellipsoid. __
...
Extra Information for the Iso Surface SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
