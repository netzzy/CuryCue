...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[underTOP_Class](<./UnderTOP_Class.md> "UnderTOP Class")
...
Extra Information for the Under TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
