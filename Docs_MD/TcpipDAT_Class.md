...
This class inherits from the [ DAT class](<./DAT_Class.md> "DAT Class"). It references a specific [TCP/IP DAT](<./TCP/IP_DAT.md> "TCP/IP DAT"). 
...
>     
[/code]`send(*messages , terminator=' ')`→`int`: 
...
See also: [Peer Class](<./Peer_Class.md> "Peer Class")
[code] 
    # me - this DAT
    # 
