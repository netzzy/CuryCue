...
The Kinect TOP captures video from the [Kinect](<./Kinect.md> "Kinect") depth camera or RGB color camera. 
...
See also [Kinect CHOP](<./Kinect_CHOP.md> "Kinect CHOP"), [Kinect](<./Kinect.md> "Kinect") and [Kinect1](<./Kinect1.md> "Kinect1"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[kinectTOP_Class](<./KinectTOP_Class.md> "KinectTOP Class")
...
Extra Information for the Kinect TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
