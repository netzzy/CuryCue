...
See [Using Shared Memory in TouchDesigner](<./Using_Shared_Memory_in_TouchDesigner.md> "Using Shared Memory in TouchDesigner") and [Shared Mem Out TOP](<./Shared_Mem_Out_TOP.md> "Shared Mem Out TOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[sharedmeminTOP_Class](</SharedmeminTOP_Class> "SharedmeminTOP Class")
...
Extra Information for the Shared Mem In TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
