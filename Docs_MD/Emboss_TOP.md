...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[embossTOP_Class](<./EmbossTOP_Class.md> "EmbossTOP Class")
...
Extra Information for the Emboss TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
