...
You can freeze the set of data held in the Cache POP by turning off the Active toggle parameter. You can clear and hold the cache to zero frames while the Reset parameter is on (the input is simply sent to the output), and you can hit Reset Pulse to clear the cache and start growing the cache again right away. (An [Info CHOP](<./Info_CHOP.md> "Info CHOP") connected to a Cache POP will show the number of frames in the cache.) 
...
See also [Cache Select POP](<./Cache_Select_POP.md> "Cache Select POP"), [Cache Blend POP](<./Cache_Blend_POP.md> "Cache Blend POP"), [Trail POP](<./Trail_POP.md> "Trail POP"), [Cache TOP](<./Cache_TOP.md> "Cache TOP"), [Texture 3D TOP](<./Texture_3D_TOP.md> "Texture 3D TOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[cachePOP_Class](</CachePOP_Class> "CachePOP Class")
...
Output Index`outputindex`\- ⊞ \- Specify tbe index of POP to output - 0 is current, negative is farther into past. 
...
Extra Information for the Cache POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
