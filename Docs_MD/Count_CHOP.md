...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[countCHOP_Class](<./CountCHOP_Class.md> "CountCHOP Class")
...
Extra Information for the Count CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
