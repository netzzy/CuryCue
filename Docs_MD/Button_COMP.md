...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[buttonCOMP_Class](<./ButtonCOMP_Class.md> "ButtonCOMP Class")
...
Extra Information for the Button COMP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
