...
This class inherits from the [ CHOP class](<./CHOP_Class.md> "CHOP Class"). It references a specific [DMX In CHOP](<./DMX_In_CHOP.md> "DMX In CHOP"). 

## Members`timecode`→`tdu.Timecode`**(Read Only)** : 

> Get a Timecode object for the last ArtTimeCode packet received. See [Timecode Class](<./Timecode_Class.md> "Timecode Class").
