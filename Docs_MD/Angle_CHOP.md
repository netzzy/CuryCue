...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[angleCHOP_Class](<./AngleCHOP_Class.md> "AngleCHOP Class")
...
Extra Information for the Angle CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
