...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[linethickSOP_Class](<./LinethickSOP_Class.md> "LinethickSOP Class")
...
Extra Information for the Line Thick SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
