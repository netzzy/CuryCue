...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[superquadSOP_Class](</SuperquadSOP_Class> "SuperquadSOP Class")

## 

Parameters - Page

Primitive Type`type`\- ⊞ \- Select from the following types. For information on the different types, see the [Primitive](<./Primitive.md> "Primitive") article. Depending on the primitive type chosen, some SOP options may not apply. 
* Polygon`poly`-
* Mesh`mesh`-
...
Extra Information for the Superquad SOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
