...
The Inverse Curve CHOP calculates an inverse kinematics simulation for [bone objects](<./Bone_COMP.md> "Bone COMP") using a curve object. 

The Inverse Curve CHOP will stretch and position a set of bones to follow a curve defined by another set of [objects](<./Object.md> "Object") (guide). 
...
You can view this curve by using the [Inverse Curve SOP](<./Inverse_Curve_SOP.md> "Inverse Curve SOP"). Just supply it with the name of the Inverse Curve CHOP and it will extract the geometry for viewing/debugging purposes. It actually will contain 3 curves (the original guide, and the guide displaced in +X and +Y). These curves can be skinned with a [Skin SOP](<./Skin_SOP.md> "Skin SOP") for better feedback, etc. 
...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[inversecurveCHOP_Class](<./InversecurveCHOP_Class.md> "InversecurveCHOP Class")
...
Extra Information for the Inverse Curve CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
