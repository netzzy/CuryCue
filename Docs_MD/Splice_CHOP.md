...
Check [OP Snippets](<./OP_Snippets.md> "OP Snippets") for these and other tricks. 

See also [Delete CHOP](<./Delete_CHOP.md> "Delete CHOP"), [Trim CHOP](<./Trim_CHOP.md> "Trim CHOP"), [Select CHOP](<./Select_CHOP.md> "Select CHOP")

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[spliceCHOP_Class](</SpliceCHOP_Class> "SpliceCHOP Class")
...
Extra Information for the Splice CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
