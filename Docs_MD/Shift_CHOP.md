...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[shiftCHOP_Class](<./ShiftCHOP_Class.md> "ShiftCHOP Class")
...
Extra Information for the Shift CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
