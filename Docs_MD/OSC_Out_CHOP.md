...
OSC bundles allows you to send a group of messages in a single command rather than as separate, individual messages. The [OSC Out DAT](<./OSC_Out_DAT.md> "OSC Out DAT") has a`sendOSC()`function that will accept a list of messages and send as a bundle. 

See also [OSC In CHOP](<./OSC_In_CHOP.md> "OSC In CHOP"), [OSC Out DAT](<./OSC_Out_DAT.md> "OSC Out DAT"), [OSC In DAT](<./OSC_In_DAT.md> "OSC In DAT"), [iOS and OSC](<./IOS_and_OSC.md> "IOS and OSC"), [Touch Out CHOP](<./Touch_Out_CHOP.md> "Touch Out CHOP"), [UDP Out DAT](<./UDP_Out_DAT.md> "UDP Out DAT"), [TCP/IP DAT](<./TCP/IP_DAT.md> "TCP/IP DAT"). 

**NOTE for Windows OS - If experiencing connection issues make sure Windows Firewall is disabled.**

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[oscoutCHOP_Class](<./OscoutCHOP_Class.md> "OscoutCHOP Class")
...
* Time Slice`timeslice`\- Sends all samples of the current [Time Slice](</index.php?title=Time_Slice&action=edit&redlink=1> "Time Slice \(page does not exist\)") in each channel.
...
Extra Information for the OSC Out CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
