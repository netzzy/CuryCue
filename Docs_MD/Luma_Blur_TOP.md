...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[lumablurTOP_Class](<./LumablurTOP_Class.md> "LumablurTOP Class")
...
Extra Information for the Luma Blur TOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
