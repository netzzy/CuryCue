...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[convertPOP_Class](</ConvertPOP_Class> "ConvertPOP Class")
...
Extra Information for the Convert POP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
