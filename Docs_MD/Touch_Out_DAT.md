...
[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[touchoutDAT_Class](</TouchoutDAT_Class> "TouchoutDAT Class")
...
Extra Information for the Touch Out DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). 
