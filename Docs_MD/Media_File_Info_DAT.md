...
A media file can be inputted to the DAT by either specifying the File path, or by referencing a [Movie File In TOP](<./Movie_File_In_TOP.md> "Movie File In TOP") or [Audio File In CHOP](<./Audio_File_In_CHOP.md> "Audio File In CHOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[mediafileinfoDAT_Class](<./MediafileinfoDAT_Class.md> "MediafileinfoDAT Class")
...
TOP/CHOP`topchop`\- Reference to a [Movie File In TOP](<./Movie_File_In_TOP.md> "Movie File In TOP") or [Audio File In CHOP](<./Audio_File_In_CHOP.md> "Audio File In CHOP") to read file information from. 
...
Extra Information for the Media File Info DAT can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
