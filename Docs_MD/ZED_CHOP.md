...
Additionally, the ZED CHOP can do skeleton tracking by enabling the 'Body Tracking' menu. 

**NOTE:** This CHOP works with the [Stereolabs ZED](<https://www.stereolabs.com/zed/>) hardware. For more information and to know what ZED SDK to install refer to the [ZED](<./ZED.md> "ZED") article. 

See also [ZED TOP](<./ZED_TOP.md> "ZED TOP"), [ZED POP](<./ZED_POP.md> "ZED POP") and [ZED SOP](<./ZED_SOP.md> "ZED SOP"). 

[![PythonIcon.png](./images/c/c2/PythonIcon.png)](</File:PythonIcon.png>)[zedCHOP_Class](<./ZedCHOP_Class.md> "ZedCHOP Class")
...
ZED TOP`zedtop`\- The name of the primary [ZED TOP](<./ZED_TOP.md> "ZED TOP") that is configuring the camera. The primary TOP controls which camera the CHOP receives data from. 
...
Extra Information for the ZED CHOP can be accessed via an [Info CHOP](<./Info_CHOP.md> "Info CHOP"). __
