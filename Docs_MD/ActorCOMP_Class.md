...
This class inherits from the [ COMP class](<./COMP_Class.md> "COMP Class"). It references a specific [Actor COMP](<./Actor_COMP.md> "Actor COMP").   
  
## Members`bodies`→`list`**(Read Only)** : 

> Returns a list of all the bodies in the [Actor COMP](<./Actor_COMP.md> "Actor COMP"). Each entry in the list will be a [Body Class](<./Body_Class.md> "Body Class") object.
...
TouchDesigner Build: Latest\nmw-blank2022.241402021.100002020.200002019.146502018.28070
