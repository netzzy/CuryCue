...
You can also use`[probe](<./Palette-probe.md> "Palette:probe")`in the [Palette](<./Palette.md> "Palette") to watch network cook times live. 
...
This output can also be saved to a text file. Note a 30fps system will take ~33ms each frame and a 60fps system will take ~16ms.`[probe](<./Palette-probe.md> "Palette:probe")`in the [Palette](<./Palette.md> "Palette") also helps identify fluctuations in cook time. 
